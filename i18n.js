...
const i18n = {
    en: {
        ...
        tours_hud_sub: 'GUIDED TOURS · OPEN',
        ...
        welcome_start_tour: 'DEMO TOUR', welcome_explore: 'EXPLORE FREELY',
        welcome_dont_show: "Don't show again",
        ob_value: 'The interactive world atlas for school and university',
        ob_feat_tours: 'guided tours — from the Roman Empire to the climate crisis',
        ob_feat_subjects: 'For history, geography, politics, religion and science',
        ob_feat_sheets: 'Worksheet & QR code for every tour — projector or tablet',
        welcome_browse_tours: 'BROWSE THE TOURS',
        ob_ticker_quakes: 'earthquakes in the last hour', ob_ticker_iss: 'ISS over',
        welcome_footer: 'Free · No login · No ads · No cookies',
    ...
    de: {
        ...
        tours_hud_sub: 'GEFÜHRTE TOUREN · ÖFFNEN',
        ...
        welcome_start_tour: 'DEMO-TOUR', welcome_explore: 'FREI ERKUNDEN',
        ob_value: 'Der interaktive Weltatlas für Schule und Uni',
        ob_feat_tours: 'geführte Touren – vom Römischen Reich bis zur Klimakrise',
        ob_feat_subjects: 'Für Geschichte, Erdkunde, Politik, Religion und Naturwissenschaft',
        ob_feat_sheets: 'Arbeitsblatt & QR-Code zu jeder Tour – für Beamer oder Tablet',
        welcome_browse_tours: 'TOUREN ENTDECKEN',
        ob_ticker_quakes: 'Erdbeben in der letzten Stunde', ob_ticker_iss: 'ISS über',
        welcome_dont_show: 'Nicht mehr anzeigen',
        welcome_footer: 'Kostenlos · Ohne Login · Ohne Werbung · Ohne Cookies',
