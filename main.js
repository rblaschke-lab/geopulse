...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const TOURS = {
        welcome: {
            ...
            steps: [
                ...
                },
                {
                    ...
                    title_de: 'ðŸ›ï¸ GEFÜHRTE TOUREN — LERNEN DURCH ENTDECKEN',
        ...
        ww1: {
            ...
            steps: [
                ...
                {
                    center: [2.90, 49.43], zoom: 8, title: 'ðŸª– COMPIÈGNE — THE ARMISTICE',
    ...
    function speakText(text) {
        ...
        const cleanText = text
            ...
            .replace(/[ðŸ“ðŸ¢ðŸ“ŠðŸ”’ðŸ“â˜¢ï¸ðŸŒ±ðŸš«ðŸ’€ðŸ“œðŸ”§ðŸ’°ðŸ´â€â˜ ï¸ðŸ’£⚡ðŸŒ‹ðŸ›ï¸âš“ðŸš¢ðŸï¸ðŸ]/g, '')
            .replace(/\s+/g, ' ')
            .trim();
