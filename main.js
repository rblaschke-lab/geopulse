...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const initISS = () => {
        ...
        const buildISSPopupHTML = () => `<div style="font-family:'Share Tech Mono',monospace;font-size:.72rem;max-width:320px;">
                    ...
                    <div style="font-size:.55rem;opacity:.55;line-height:1.5;margin-bottom:6px;">
                        ${currentLang==='de'?'109m Ã— 73m — gröÃŸtes Bauwerk im All. Umkreist die Erde mit ~28.000 km/h. Mit bloÃŸem Auge sichtbar. Hat 280+ Astronauten aus 21 Ländern beherbergt.':'109m Ã— 73m — largest structure in space. Orbits at ~28,000 km/h. Visible from Earth with naked eye. Has hosted 280+ astronauts from 21 countries.'}
                    </div>
    ...
    document.getElementById('toggle-borders')?.addEventListener('change', async (e) => {
        ...
        if (toggles.borders && !map.getSource('borders-src')) {
            try {
                ...
                setStatus(currentLang === 'de' ? 'LÃ„NDERGRENZEN GELADEN — ' + COUNTRY_CENTROIDS.length + ' NATIONEN' : 'COUNTRY BOUNDARIES LOADED — ' + COUNTRY_CENTROIDS.length + ' NATIONS');
    ...
    const TOURS = {
            ...
            steps: [
                {
                    ...
                    title: 'ðŸŒ REAL-TIME DATA — LIVE FROM SPACE',
                    title_de: 'ðŸŒ ECHTZEIT-DATEN — LIVE AUS DEM ALL',
                ...
                },
                {
                    ...
                    title: 'ðŸ›ï¸ GUIDED TOURS — LEARN BY EXPLORING',
                    title_de: 'ðŸ›ï¸ GEFÃœHRTE TOUREN — LERNEN DURCH ENTDECKEN',
                ...
                {
                    center: [20, 20], zoom: 2,
                    title: 'ðŸ—ºï¸ YOUR COMMAND CENTER — 20+ LAYERS',
                    title_de: 'ðŸ—ºï¸ IHRE KOMMANDOZENTRALE — 20+ EBENEN',
                    ...
                    text_de: 'Ã–ffnen Sie die Seitenleiste (oben rechts) für 22+ Datenebenen: Regierungsformen, Militärbündnisse, Konfliktzonen, Seekabel, Atomstandorte, Polarlichtvorhersagen, Meteoreinschläge und mehr. Kombinieren Sie Ebenen, um Muster zu entdecken — etwa wie Konfliktzonen sich mit Ressourcenrouten überschneiden. Dies ist Ihr globales Nachrichtenzentrum. Viel SpaÃŸ beim Erkunden!',
                    layers: []
                }
            ]
        },
        ...
        trump: {
            ...
            steps: [
                {
                    center: [-77.04, 38.9], zoom: 6, title: 'ðŸ›ï¸ WASHINGTON D.C. — AMERICA FIRST RELOADED',
                ...
                {
                    center: [-75.7, 45.4], zoom: 4, title: 'ðŸ CANADA — ALLIANCE UNDER PRESSURE',
                ...
                {
                    center: [-42, 72], zoom: 4, title: 'â„ï¸ GREENLAND — STRATEGIC ARCTIC AMBITION',
                ...
                {
                    center: [-79.9, 9.1], zoom: 6, title: 'ðŸš¢ PANAMA CANAL — TRADE ROUTE TENSIONS',
                ...
                {
                    center: [-66.9, 10.5], zoom: 5, title: 'âš¡ VENEZUELA — HARD POWER RETURNS',
                ...
                {
                    center: [-20, 25], zoom: 2, title: 'ðŸŒ THE NEW WORLD ORDER — CAUSE & EFFECT',
        ...
        chokepoints: {
            ...
            steps: [
                {
                    center: [56.3, 26.6], zoom: 6, title: 'â›½ STRAIT OF HORMUZ — THE OIL GATE',
                ...
                {
                    center: [32.3, 30.5], zoom: 6, title: 'ðŸš¢ SUEZ CANAL — THE SHORTCUT THAT CHANGED HISTORY',
                ...
                {
                    center: [104, 1.3], zoom: 5, title: 'âš“ STRAIT OF MALACCA — ASIA\'S LIFELINE',
                ...
                {
                    center: [43.3, 12.6], zoom: 6, title: 'ðŸ”¥ BAB EL-MANDEB — THE GATE OF TEARS',
                ...
                {
                    center: [-5.5, 35.9], zoom: 7, title: 'ðŸ›ï¸ STRAIT OF GIBRALTAR — MEDITERRANEAN GATE',
                ...
                {
                    center: [-79.5, 9.1], zoom: 6, title: 'ðŸš¢ PANAMA CANAL — THE GREAT SHORTCUT',
                ...
                {
                    center: [20, 25], zoom: 2, title: 'ðŸŒ THE CHOKEPOINT MAP — FRAGILE BY DESIGN',
        ...
        battery: {
            ...
            steps: [
                {
                    center: [25.5, -4.3], zoom: 5, title: 'â›ï¸ CONGO — THE COBALT MINES',
                ...
                {
                    center: [-68, -23.5], zoom: 5, title: 'ðŸ”‹ LITHIUM TRIANGLE — THE WHITE GOLD',
                ...
                {
                    center: [120.96, 24.8], zoom: 6, title: 'ðŸ”¬ TAIWAN — THE CHIP BOTTLENECK',
                ...
                {
                    center: [-118, 36], zoom: 4, title: 'ðŸ­ GIGAFACTORIES — THE ASSEMBLY LINE',
                ...
                {
                    center: [30, 15], zoom: 2, title: 'ðŸŒ THE BATTERY SUPPLY CHAIN — MAPPED',
        ...
        climate: {
            ...
            steps: [
                {
                    center: [16, 78.2], zoom: 5, title: 'â„ï¸ SVALBARD — THE ARCTIC CANARY',
                    text: 'Svalbard, halfway between Norway and the North Pole, is warming 7x faster than the global average. Permafrost that has been frozen for 10,000+ years is thawing, releasing methane — a greenhouse gas 80x more potent than COâ‚‚ over 20 years. The Global Seed Vault here, designed to survive any catastrophe, had water leak into its entrance tunnel in 2017 due to unexpected melting.',
                    layers: ['volcanoes']
                },
                {
                    center: [147, -18.3], zoom: 5, title: 'ðŸ  GREAT BARRIER REEF — MASS BLEACHING',
                ...
                {
                    center: [-60, -3], zoom: 4, title: 'ðŸŒ³ AMAZON — THE LUNGS ARE BURNING',
                ...
                {
                    center: [90, 23.7], zoom: 5, title: 'ðŸŒŠ BANGLADESH — DROWNING IN SLOW MOTION',
                ...
                {
                    center: [179, -8.5], zoom: 6, title: 'ðŸï¸ TUVALU — THE NATION THAT DISAPPEARS',
                ...
                {
                    center: [-120, 37], zoom: 5, title: 'ðŸ”¥ CALIFORNIA — FIRE SEASON IS NOW YEAR-ROUND',
                ...
                {
                    center: [10, 20], zoom: 2, title: 'ðŸŒ CLIMATE FRONTLINES — THE MAP DOESN\'T LIE',
        ...
        water: {
            ...
            steps: [
                {
                    center: [35, 15], zoom: 5, title: 'ðŸ—ï¸ NILE — THE GREAT DAM STANDOFF',
                ...
                {
                    center: [72, 32], zoom: 5, title: 'âš”ï¸ INDUS — TWO NUCLEAR POWERS, ONE RIVER',
                ...
                {
                    center: [-111, 36.5], zoom: 5, title: 'ðŸœï¸ COLORADO RIVER — RUNNING DRY',
                ...
                {
                    center: [60, 45], zoom: 5, title: 'ðŸ’€ ARAL SEA — THE GREATEST ENVIRONMENTAL DISASTER',
                ...
                {
                    center: [14, 13], zoom: 5, title: 'ðŸŒ LAKE CHAD — A CONTINENT\'S CRISIS',
                ...
                {
                    center: [40, 25], zoom: 2, title: 'ðŸ’§ WATER WARS — THE 21ST CENTURY THREAT',
        ...
        f1: {
            ...
            steps: [
                {
                    center: [7.420, 43.737], zoom: 14, title: 'ðŸŽï¸ MONACO — THE JEWEL IN THE CROWN',
                ...
                {
                    center: [-1.017, 52.073], zoom: 14, title: 'ðŸŽï¸ SILVERSTONE — WHERE IT ALL BEGAN',
                ...
                {
                    center: [9.289, 45.621], zoom: 14, title: 'ðŸŽï¸ MONZA — THE TEMPLE OF SPEED',
                ...
                {
                    center: [5.971, 50.437], zoom: 14, title: 'ðŸŽï¸ SPA-FRANCORCHAMPS — THE DRIVERS\' FAVOURITE',
                ...
                {
                    center: [136.541, 34.843], zoom: 14, title: 'ðŸŽï¸ SUZUKA — PRECISION ENGINEERING',
                ...
                {
                    center: [-46.698, -23.702], zoom: 14, title: 'ðŸŽï¸ INTERLAGOS — WHERE LEGENDS ARE MADE',
                ...
                {
                    center: [103.864, 1.291], zoom: 14, title: 'ðŸŽï¸ SINGAPORE — THE NIGHT SPECTACLE',
                ...
                {
                    center: [54.603, 24.467], zoom: 14, title: 'ðŸŽï¸ YAS MARINA — THE SEASON FINALE',
                ...
                {
                    center: [20, 20], zoom: 2, title: 'ðŸ FORMULA 1 — THE GLOBAL CIRCUS',
        ...
        worldcup: {
            ...
            steps: [
                {
                    center: [-43.23, -22.91], zoom: 6, title: 'âš½ BRAZIL 2014 — FOOTBALL COMES HOME',
                ...
                {
                    center: [37.62, 55.75], zoom: 5, title: 'âš½ RUSSIA 2018 — EAST MEETS WEST',
                ...
                {
                    center: [51.44, 25.35], zoom: 6, title: 'âš½ QATAR 2022 — THE DESERT FINAL',
                ...
                {
                    center: [-99.13, 19.43], zoom: 4, title: 'âš½ 2026 — UNITED BID (USA, CANADA, MEXICO)',
                ...
                {
                    center: [46.68, 24.71], zoom: 5, title: 'âš½ 2034 — SAUDI ARABIA',
                ...
                {
                    center: [13.38, 52.52], zoom: 5, title: 'âš½ GERMANY 2006 — THE SUMMER FAIRYTALE',
                ...
                {
                    center: [28.23, -25.74], zoom: 5, title: 'âš½ SOUTH AFRICA 2010 — AFRICA\'S MOMENT',
                ...
                {
                    center: [10, 20], zoom: 2, title: 'ðŸ† THE WORLD CUP — FOOTBALL\'S UNIVERSE',
        ...
        ww1: {
            ...
            steps: [
                {
                    center: [15, 48], zoom: 2, title: 'ðŸª– THE GREAT WAR — OVERVIEW',
                ...
                {
                    center: [18.43, 43.86], zoom: 8, title: 'ðŸª– SARAJEVO — THE SPARK',
                ...
                {
                    center: [5.39, 49.16], zoom: 8, title: 'ðŸª– VERDUN — THE MEATGRINDER',
                ...
                {
                    center: [2.89, 50.85], zoom: 8, title: 'ðŸª– YPRES — POISON GAS',
                ...
                {
                    center: [26.29, 40.34], zoom: 7, title: 'ðŸª– GALLIPOLI — CHURCHILL\'S GAMBLE',
                ...
                {
                    center: [2.72, 50.00], zoom: 7, title: 'ðŸª– THE SOMME — INDUSTRIAL DEATH',
                ...
                {
                    center: [2.90, 49.43], zoom: 8, title: 'ðŸª– COMPIÃˆGNE — THE ARMISTICE',
                ...
                {
                    center: [2.12, 48.80], zoom: 8, title: 'ðŸª– VERSAILLES — SEEDS OF THE NEXT WAR',
        ...
        ww2: {
            ...
            steps: [
                {
                    center: [20, 40], zoom: 2, title: 'âš”ï¸ WORLD WAR II — OVERVIEW',
                ...
                {
                    center: [18.65, 54.35], zoom: 7, title: 'âš”ï¸ GDAÅƒSK — THE FIRST SHOTS',
                ...
                {
                    center: [-0.12, 51.51], zoom: 6, title: 'âš”ï¸ LONDON — THE BLITZ',
                ...
                {
                    center: [44.52, 48.72], zoom: 7, title: 'âš”ï¸ STALINGRAD — THE TURNING POINT',
                ...
                {
                    center: [19.20, 50.04], zoom: 9, title: 'âš”ï¸ AUSCHWITZ — THE HOLOCAUST',
                ...
                {
                    center: [-0.87, 49.36], zoom: 8, title: 'âš”ï¸ NORMANDY — D-DAY',
                ...
                {
                    center: [132.45, 34.39], zoom: 8, title: 'âš”ï¸ HIROSHIMA — THE ATOMIC AGE',
                ...
                {
                    center: [13.38, 52.52], zoom: 7, title: 'âš”ï¸ BERLIN — FALL OF THE THIRD REICH',
                ...
                {
                    center: [20, 30], zoom: 2, title: 'âš”ï¸ LEGACY — A NEW WORLD ORDER',
        ...
        romanempire: {
            ...
            steps: [
                {
                    center: [18, 40], zoom: 3, title: 'ðŸ›ï¸ THE ROMAN EMPIRE — AT ITS GREATEST EXTENT',
                ...
                {
                    center: [12.49, 41.89], zoom: 8, title: 'ðŸ›ï¸ ROME — CAPUT MUNDI',
                ...
                {
                    center: [9.0, 49.5], zoom: 6, title: 'âš”ï¸ THE LIMES — ROME\'S FRONTIER IN GERMANIA',
                ...
                {
                    center: [31.25, 30.05], zoom: 6, title: 'ðŸº EGYPT — ROME\'S BREADBASKET',
                ...
                {
                    center: [14.49, 40.75], zoom: 9, title: 'ðŸŒ‹ POMPEII — FROZEN IN TIME',
                ...
                {
                    center: [28.98, 41.01], zoom: 8, title: 'â­ CONSTANTINOPLE — THE SECOND ROME',
                ...
                {
                    center: [-1.5, 52.5], zoom: 6, title: 'ðŸ›¡ï¸ BRITANNIA — THE EDGE OF THE WORLD',
                ...
                {
                    center: [18, 40], zoom: 3, title: 'ðŸŒ FALL & LEGACY — WHY ROME STILL MATTERS',
        ...
        quakes: {
            ...
            steps: [
                {
                    center: [142.37, 38.32], zoom: 14, title: 'ðŸŒŠ TÅŒHOKU EARTHQUAKE — JAPAN, 2011',
                ...
                {
                    center: [80.2, 7.0], zoom: 14, title: 'ðŸŒŠ INDIAN OCEAN TSUNAMI — 2004',
                ...
                {
                    center: [-72.3, 18.5], zoom: 14, title: 'ðŸ’” HAITI EARTHQUAKE — 2010',
                ...
                {
                    center: [36.2, 37.2], zoom: 14, title: 'ðŸ’” TURKEY-SYRIA EARTHQUAKE — 2023',
                ...
                {
                    center: [14.43, 40.82], zoom: 14, title: 'ðŸŒ‹ VESUVIUS — POMPEII, 79 AD',
                ...
                {
                    center: [105.42, -6.10], zoom: 14, title: 'ðŸŒ‹ KRAKATOA — INDONESIA, 1883',
                ...
                {
                    center: [118.0, -8.4], zoom: 14, title: 'ðŸŒ‹ TAMBORA — THE YEAR WITHOUT A SUMMER, 1815',
                ...
                {
                    center: [30, 15], zoom: 2, title: 'ðŸŒ EARTHQUAKES & ERUPTIONS — THE NUMBERS',
        ...
        olympics: {
            ...
            steps: [
                {
                    center: [23.72, 37.97], zoom: 7, title: 'ðŸ›ï¸ ATHENS 1896 — THE REVIVAL',
                ...
                {
                    center: [13.38, 52.52], zoom: 7, title: 'âœŠ BERLIN 1936 — PROPAGANDA & DEFIANCE',
                ...
                {
                    center: [11.58, 48.14], zoom: 7, title: 'ðŸ˜¢ MUNICH 1972 — TERROR AT THE GAMES',
                ...
                {
                    center: [10, 30], zoom: 2, title: 'ðŸ… OLYMPIC GAMES — BY THE NUMBERS',
        ...
        migration: {
            ...
            steps: [
                { center: [15, 35], zoom: 4, title: 'ðŸš¶ CENTRAL MEDITERRANEAN — EUROPE\'S DEADLIEST BORDER', title_de: 'ðŸš¶ ZENTRALES MITTELMEER — EUROPAS TÃ–DLICHSTE GRENZE', text: 'ðŸ“ ROUTE: Libya/Tunisia → Italy (Lampedusa, Sicily)\nðŸ“ DISTANCE: 300–600 km across open sea\nðŸ‘¥ REFUGEES: ~180,000 arrivals in 2023 (Italy)\nðŸ’€ DEATH TOLL: 28,000+ since 2014 — the deadliest migration route on Earth.\n\nOvercrowded dinghies launched by Libyan smugglers carry 100–150 people across the Mediterranean. Life jackets are often fake. Boats frequently capsize within hours of departure. In April 2015, 800 people drowned in a single shipwreck off Lampedusa. The EU\'s Frontex agency patrols 2.5 million km² of sea. Italy\'s Lampedusa (pop. 6,000) has received more refugees than its own population. Many who survive the crossing end up in overcrowded reception centers for months.', text_de: 'ðŸ“ ROUTE: Libyen/Tunesien → Italien (Lampedusa, Sizilien)\nðŸ“ DISTANZ: 300–600 km über offenes Meer\nðŸ‘¥ FLÃœCHTLINGE: ~180.000 Ankünfte 2023 (Italien)\nðŸ’€ TODESOPFER: 28.000+ seit 2014 — die tödlichste Fluchtroute der Erde.\n\nÃœberfüllte Schlauchboote mit 100–150 Menschen werden von libyschen Schmugglern aufs Mittelmeer geschickt. Schwimmwesten sind oft Fälschungen. Im April 2015 ertranken 800 Menschen bei einem einzigen Schiffbruch vor Lampedusa.', layers: ['conflicts'], image: { wiki: 'European_migrant_crisis', caption: 'Refugee boat in the Mediterranean' } },
                { center: [-99, 26], zoom: 5, title: 'ðŸš¶ US-MEXICO BORDER — THE DESERT WALL', title_de: 'ðŸš¶ US-MEXIKO-GRENZE — DIE WÃœSTENMAUER', text: 'ðŸ“ ROUTE: Central America/Mexico → USA (Arizona, Texas, California)\nðŸ“ DISTANCE: 3,145 km border length; migrants walk 80–200 km through desert\nðŸ‘¥ REFUGEES: 2.5 million encounters at the border in 2023 (US CBP)\nðŸ’€ DEATH TOLL: 10,000+ since 1998 — mostly from dehydration, heat stroke, drowning in the Rio Grande.\n\nMigrants from Honduras, Guatemala, El Salvador, and Venezuela flee gang violence, poverty, and climate disasters. "La Bestia" — freight trains through Mexico — carry thousands north, with many falling or being pushed off. Smuggler fees: $4,000–$15,000 per person. The border wall (1,050 km of barriers) has pushed crossings into more dangerous desert terrain, increasing deaths. Unaccompanied minors: 130,000+ in US custody in 2023.', text_de: 'ðŸ“ ROUTE: Zentralamerika/Mexiko → USA (Arizona, Texas, Kalifornien)\nðŸ“ DISTANZ: 3.145 km Grenzlänge; Migranten laufen 80–200 km durch Wüste\nðŸ‘¥ FLÃœCHTLINGE: 2,5 Millionen Grenzkontakte 2023 (US CBP)\nðŸ’€ TODESOPFER: 10.000+ seit 1998 — vor allem durch Dehydrierung und Hitzschlag.\n\nMigranten aus Honduras, Guatemala, El Salvador und Venezuela fliehen vor Bandengewalt, Armut und Klimakatastrophen. Schmuggler verlangen $4.000–$15.000 pro Person. Die Grenzmauer hat Ãœberquerungen in gefährlicheres Wüstengelände verdrängt.', layers: ['conflicts'], image: { wiki: 'Mexico–United_States_border', caption: 'US-Mexico border wall, Arizona' } },
                { center: [92.2, 21.4], zoom: 6, title: 'ðŸš¶ ROHINGYA EXODUS — MYANMAR TO BANGLADESH', title_de: 'ðŸš¶ ROHINGYA-EXODUS — MYANMAR NACH BANGLADESCH', text: 'ðŸ“ ROUTE: Rakhine State, Myanmar → Cox\'s Bazar, Bangladesh\nðŸ“ DISTANCE: 50–100 km on foot through jungle and rivers\nðŸ‘¥ REFUGEES: 960,000+ Rohingya in Bangladesh (2024) — largest refugee camp complex on Earth\nðŸ’€ DEATH TOLL: 24,000+ killed in Myanmar (UN estimate); 9,000+ in a single month (Aug 2017)\n\nThe Rohingya, a Muslim minority, faced systematic genocide by the Myanmar military in August 2017. Entire villages were burned. Women were systematically raped as a weapon of war. 740,000 people fled to Bangladesh in just 3 months. The Kutupalong-Balukhali camp houses 600,000+ people in an area of 13 km². Monsoon flooding and landslides kill dozens annually. Bangladesh cannot absorb them; Myanmar refuses to take them back. The UN called it "a textbook example of ethnic cleansing."', text_de: 'ðŸ“ ROUTE: Rakhine-Staat, Myanmar → Cox\'s Bazar, Bangladesch\nðŸ“ DISTANZ: 50–100 km zu FuÃŸ durch Dschungel\nðŸ‘¥ FLÃœCHTLINGE: 960.000+ Rohingya in Bangladesch (2024)\nðŸ’€ TODESOPFER: 24.000+ in Myanmar getötet; 9.000+ in einem einzigen Monat (Aug. 2017)\n\nDie Rohingya erlebten 2017 einen systematischen Genozid durch das myanmarische Militär. 740.000 Menschen flohen in nur 3 Monaten. Die UNO nannte es "ein Lehrbuchbeispiel für ethnische Säuberung."', layers: ['conflicts', 'regimes'], image: { wiki: 'Rohingya_genocide', caption: 'Rohingya refugees, Cox\'s Bazar' } },
                { center: [-67, 7], zoom: 5, title: 'ðŸš¶ VENEZUELAN DIASPORA — 8 MILLION DISPLACED', title_de: 'ðŸš¶ VENEZOLANISCHE DIASPORA — 8 MILLIONEN VERTRIEBENE', text: 'ðŸ“ ROUTE: Venezuela → Colombia, Peru, Chile, Brazil, Ecuador\nðŸ“ DISTANCE: Up to 5,000 km on foot — many walk the entire route\nðŸ‘¥ REFUGEES: 7.7 million Venezuelans displaced since 2015 — largest displacement crisis in the Americas\nðŸ’€ DEATH TOLL: Unknown thousands — from exhaustion, hypothermia crossing the Andes, criminal violence\n\nVenezuela\'s economic collapse under Maduro created hyperinflation of 1,000,000%+, food shortages, and a destroyed healthcare system. Families walk for weeks through Colombia\'s mountains, crossing the Darién Gap (a 100 km roadless jungle between Colombia and Panama). Children and elderly die of exposure crossing the 4,000m Andes passes. Colombia hosts 2.9 million Venezuelan refugees — the most of any country. Most work in the informal economy without legal protection.', text_de: 'ðŸ“ ROUTE: Venezuela → Kolumbien, Peru, Chile, Brasilien, Ecuador\nðŸ“ DISTANZ: Bis zu 5.000 km zu FuÃŸ\nðŸ‘¥ FLÃœCHTLINGE: 7,7 Millionen Venezolaner seit 2015 vertrieben\nðŸ’€ TODESOPFER: Unbekannte Tausende — Erschöpfung, Unterkühlung, Gewalt\n\nVenezuelas wirtschaftlicher Zusammenbruch verursachte Hyperinflation von 1.000.000%+. Familien laufen wochenlang durch Kolumbiens Berge und den Darién-Gap — 100 km Dschungel ohne StraÃŸen.', layers: ['conflicts', 'regimes'], image: { wiki: 'Venezuelan_refugee_crisis', caption: 'Venezuelan migrants crossing the Andes' } },
                { center: [20, 12], zoom: 4, title: 'ðŸš¶ SAHEL ROUTE — AFRICA\'S HIDDEN CRISIS', title_de: 'ðŸš¶ SAHEL-ROUTE — AFRIKAS VERBORGENE KRISE', text: 'ðŸ“ ROUTE: Sub-Saharan Africa → Libya/Algeria (via Niger, Chad, Sudan)\nðŸ“ DISTANCE: 2,000–4,000 km through the Sahara Desert\nðŸ‘¥ REFUGEES: ~400,000 cross the Sahara annually (IOM estimate)\nðŸ’€ DEATH TOLL: At least twice the Mediterranean toll — the Sahara may kill more migrants than any sea crossing. Bodies are found in the desert years later — most are never found at all.\n\nAgadez (Niger) is the last city before the Sahara. Smugglers pack 25–30 people onto open Toyota pickups for a 3-day crossing through 50°C heat. Vehicles break down; drivers abandon passengers. In 2013, 92 people — including women and children — died of thirst after their trucks broke down near the Algeria-Niger border. The IOM estimates that for every death recorded in the Mediterranean, two go unrecorded in the Sahara.', text_de: 'ðŸ“ ROUTE: Subsahara-Afrika → Libyen/Algerien (über Niger, Tschad, Sudan)\nðŸ“ DISTANZ: 2.000–4.000 km durch die Sahara\nðŸ‘¥ FLÃœCHTLINGE: ~400.000 überqueren jährlich die Sahara (IOM-Schätzung)\nðŸ’€ TODESOPFER: Mindestens doppelt so viele wie im Mittelmeer.\n\nSchlepper packen 25–30 Menschen auf offene Toyota-Pickups für 3 Tage bei 50°C. Fahrzeuge brechen zusammen, Fahrer lassen Passagiere zurück. Für jeden im Mittelmeer registrierten Toten sterben zwei unregistriert in der Sahara.', layers: ['conflicts'], image: { wiki: 'Agadez', caption: 'Migrant convoy, Agadez, Niger' } },
                { center: [25, 42], zoom: 5, title: 'ðŸš¶ BALKAN ROUTE — EUROPE\'S CORRIDOR', title_de: 'ðŸš¶ BALKANROUTE — EUROPAS KORRIDOR', text: 'ðŸ“ ROUTE: Turkey → Greece → North Macedonia → Serbia → Hungary/Croatia → Austria/Germany\nðŸ“ DISTANCE: 2,500–3,000 km\nðŸ‘¥ REFUGEES: 1 million+ in 2015 alone — the peak of the European refugee crisis\nðŸ’€ DEATH TOLL: 400+ since 2015 — hypothermia, drowning in rivers, landmines in border areas\n\nSyrian, Afghan, and Iraqi refugees crossed from Turkey to Greek islands (Lesbos, Kos) on rubber dinghies, then walked north through the Balkans. In 2015, 3-year-old Alan Kurdi drowned off the Turkish coast — his photo shocked the world and briefly opened European borders. Germany accepted 890,000 asylum seekers in 2015 under Angela Merkel\'s "Wir schaffen das" policy. Hungary built a razor-wire fence. The EU-Turkey deal (2016) reduced crossings by 97% — but pushed refugees onto more dangerous routes.', text_de: 'ðŸ“ ROUTE: Türkei → Griechenland → Nordmazedonien → Serbien → Ungarn/Kroatien → Ã–sterreich/Deutschland\nðŸ“ DISTANZ: 2.500–3.000 km\nðŸ‘¥ FLÃœCHTLINGE: 1 Million+ allein 2015\nðŸ’€ TODESOPFER: 400+ seit 2015\n\nSyrische, afghanische und irakische Flüchtlinge überquerten per Schlauchboot die Ã„gäis und liefen durch den Balkan nach Norden. Das Foto des ertrunkenen 3-jährigen Alan Kurdi erschütterte die Welt. Deutschland nahm 2015 unter Merkels "Wir schaffen das" 890.000 Asylsuchende auf.', layers: ['conflicts'], image: { wiki: 'European_migrant_crisis', caption: 'Refugees on the Balkan route, 2015' } },
                { center: [30, 20], zoom: 2, title: 'ðŸš¶ MIGRATION — THE GLOBAL PICTURE', title_de: 'ðŸš¶ MIGRATION — DAS GLOBALE BILD', text: 'ðŸŒ THE GREATEST DISPLACEMENT CRISIS IN HUMAN HISTORY.\n\nðŸ“Š KEY STATISTICS:\nâ• Forcibly displaced worldwide: 117.3 million people (UNHCR, 2024)\nâ• Refugees under UNHCR mandate: 36.4 million\nâ• Internally displaced: 62.5 million\nâ• Top origin countries: Syria (6.5M), Ukraine (6.3M), Afghanistan (6.1M), Venezuela (7.7M)\nâ• Top host countries: Turkey (3.6M), Iran (3.4M), Colombia (2.9M), Germany (2.6M), Pakistan (2.1M)\nâ• Deaths on migration routes since 2014: 63,000+ documented (IOM) — true figure likely 2-3x higher\nâ• Children among refugees: 40%\nâ• Average time spent as a refugee: 20 years\n\nðŸ’¡ Behind every statistic is a family that lost everything — home, safety, identity — and risked death for the chance of survival. The question is not whether people will move. It is whether the world will respond with walls or with dignity.', text_de: 'ðŸŒ DIE GRÃ–SSTE VERTREIBUNGSKRISE DER MENSCHHEITSGESCHICHTE.\n\nðŸ“Š STATISTIKEN:\nâ• Zwangsvertriebene weltweit: 117,3 Millionen (UNHCR, 2024)\nâ• Flüchtlinge: 36,4 Millionen\nâ• Binnenvertriebene: 62,5 Millionen\nâ• Tote auf Fluchtrouten seit 2014: 63.000+ dokumentiert — wahre Zahl vermutlich 2-3x höher\nâ• Kinder unter Flüchtlingen: 40%\nâ• Durchschnittliche Dauer als Flüchtling: 20 Jahre\n\nðŸ’¡ Hinter jeder Statistik steht eine Familie, die alles verloren hat. Die Frage ist nicht, ob Menschen fliehen werden. Sondern ob die Welt mit Mauern oder mit Würde antwortet.', layers: ['conflicts', 'regimes'] }
            ]
        },
        genocide: {
            ...
            category: 'society',
            steps: [
                { center: [19.2033, 50.0343], zoom: 14, title: 'âœ¡ï¸ AUSCHWITZ-BIRKENAU — THE FACTORY OF DEATH', title_de: 'âœ¡ï¸ AUSCHWITZ-BIRKENAU — DIE TODESFABRIK', text: 'ðŸ“ LOCATION: OÅ›wiÄ™cim, Poland — 60 km west of Kraków.\nâ˜ ï¸ PERIOD: 1940–1945\nðŸ’€ DEATH TOLL: 1.1 million murdered — 90% were Jewish.\n\nðŸ“Š Auschwitz was the largest Nazi extermination camp. It consisted of 3 main camps and 40+ sub-camps. At peak capacity, Birkenau\'s 4 gas chambers and crematoria could kill 6,000 people per day. Prisoners arrived in cattle cars after days without food or water. SS doctor Josef Mengele performed horrific medical experiments on twins and children. On January 27, 1945, Soviet troops liberated 7,000 surviving prisoners — walking skeletons. The camp contained 7 tons of human hair, 44,000 pairs of shoes, and 3,800 suitcases with names still attached. Today, Auschwitz is the most visited Holocaust memorial — 2.3 million visitors per year. International Holocaust Remembrance Day is observed on January 27.', text_de: 'ðŸ“ ORT: OÅ›wiÄ™cim, Polen — 60 km westlich von Krakau.\nâ˜ ï¸ ZEITRAUM: 1940–1945\nðŸ’€ TODESOPFER: 1,1 Millionen ermordet — 90% waren jüdisch.\n\nðŸ“Š Auschwitz war das gröÃŸte NS-Vernichtungslager. 3 Hauptlager und 40+ AuÃŸenlager. In Birkenau konnten 4 Gaskammern und Krematorien bis zu 6.000 Menschen pro Tag töten. Am 27. Januar 1945 befreite die Rote Armee 7.000 Ãœberlebende. Im Lager fanden sich 7 Tonnen menschliches Haar und 44.000 Paar Schuhe. Heute besuchen 2,3 Millionen Menschen pro Jahr die Gedenkstätte. Der 27. Januar ist Internationaler Holocaust-Gedenktag.', layers: ['conflicts'], image: { wiki: 'Auschwitz_concentration_camp', caption: 'Auschwitz-Birkenau gate, Poland' } },
                { center: [29.8739, -1.9536], zoom: 12, title: 'KIGALI — 100 DAYS OF SLAUGHTER', title_de: 'KIGALI — 100 TAGE DES SCHLACHTENS', text: 'ðŸ“ LOCATION: Kigali Genocide Memorial, Rwanda.\nâ˜ ï¸ PERIOD: April 7 – July 15, 1994 — 100 days.\nðŸ’€ DEATH TOLL: 800,000–1,000,000 Tutsi and moderate Hutu murdered.\n\nðŸ“Š The Rwandan genocide was the fastest mass killing in recorded history — an average of 8,000 people killed per day. Hutu extremists used radio station RTLM to broadcast kill lists and coordinates. Machetes were the primary weapon — imported in bulk from China in the months before. The UN had 2,500 peacekeepers in Rwanda (UNAMIR) under Canadian General Roméo Dallaire, who begged for reinforcements. The Security Council voted to REDUCE forces to 270. France, the UK, and the US blocked intervention. 250,000 women were raped as a weapon of war. The Kigali Memorial holds the remains of 250,000 victims. Rwanda has since become one of Africa\'s fastest-growing economies — but the trauma endures.', text_de: 'ðŸ“ ORT: Kigali Genocide Memorial, Ruanda.\nâ˜ ï¸ ZEITRAUM: 7. April – 15. Juli 1994 — 100 Tage.\nðŸ’€ TODESOPFER: 800.000–1.000.000 Tutsi und moderate Hutu ermordet.\n\nðŸ“Š Der schnellste Völkermord der Geschichte — durchschnittlich 8.000 Tote pro Tag. Hutu-Extremisten nutzten Radio RTLM zur Verbreitung von Todeslisten. Macheten waren die Hauptwaffe. Die UNO hatte 2.500 Blauhelme vor Ort — der Sicherheitsrat stimmte für eine REDUZIERUNG auf 270. Frankreich, GroÃŸbritannien und die USA blockierten jede Intervention. 250.000 Frauen wurden als Kriegswaffe vergewaltigt.', layers: ['conflicts'], image: { wiki: 'Rwandan_genocide', caption: 'Kigali Genocide Memorial, Rwanda' } },
                { center: [19.2969, 44.1072], zoom: 12, title: 'SREBRENICA — EUROPE\'S DARKEST HOUR', title_de: 'SREBRENICA — EUROPAS DUNKELSTE STUNDE', text: 'ðŸ“ LOCATION: Srebrenica-PotoÄari Memorial, Bosnia.\nâ˜ ï¸ PERIOD: July 11–22, 1995.\nðŸ’€ DEATH TOLL: 8,372 Bosniak men and boys murdered.\n\nðŸ“Š Srebrenica was a UN-declared "safe area" protected by 400 Dutch peacekeepers (Dutchbat). On July 11, 1995, Bosnian Serb forces under General Ratko MladiÄ‡ overran the enclave. The Dutch surrendered without resistance. Over 8,000 Muslim men and boys were systematically separated from women and executed in fields, warehouses, and along roadsides. Mass graves were later dug up and scattered across 50+ secondary sites to hide evidence. MladiÄ‡ was convicted of genocide by the ICTY in 2017. The PotoÄari Memorial Cemetery contains 6,671 identified victims — DNA identification continues. It was the worst massacre in Europe since World War II.', text_de: 'ðŸ“ ORT: Srebrenica-PotoÄari Gedenkstätte, Bosnien.\nâ˜ ï¸ ZEITRAUM: 11.–22. Juli 1995.\nðŸ’€ TODESOPFER: 8.372 bosniakische Männer und Jungen ermordet.\n\nðŸ“Š Srebrenica war eine UN-Schutzzone, bewacht von 400 niederländischen Blauhelmen. Am 11. Juli 1995 überrannten bosnisch-serbische Truppen unter General MladiÄ‡ die Enklave. Ãœber 8.000 muslimische Männer und Jungen wurden systematisch getrennt und erschossen. Massengräber wurden auf 50+ Sekundärstandorte verteilt. MladiÄ‡ wurde 2017 vom ICTY wegen Völkermordes verurteilt. Das schlimmste Massaker in Europa seit dem Zweiten Weltkrieg.', layers: ['conflicts'], image: { wiki: 'Srebrenica_massacre', caption: 'Srebrenica-PotoÄari Memorial' } },
                { center: [104.9160, 11.5494], zoom: 14, title: 'TUOL SLENG (S-21) — THE KILLING FIELDS', title_de: 'TUOL SLENG (S-21) — DIE KILLING FIELDS', text: 'ðŸ“ LOCATION: Phnom Penh, Cambodia.\nâ˜ ï¸ PERIOD: 1975–1979 — Khmer Rouge regime under Pol Pot.\nðŸ’€ DEATH TOLL: 1.5–2 million (25% of Cambodia\'s population).\n\nðŸ“Š Tuol Sleng was a high school converted into Security Prison 21 (S-21). Of 17,000–20,000 prisoners, only 12 survived. Prisoners were photographed, tortured into false confessions, then trucked to the Choeung Ek killing fields for execution. The Khmer Rouge emptied cities, abolished money, schools, and religion, and executed anyone with education — wearing glasses was a death sentence. The regime targeted ethnic Vietnamese, Chinese, Thai, and Muslim Cham minorities. Mass graves at Choeung Ek contain 8,985 bodies. A Buddhist stupa memorial displays 5,000 skulls. The Khmer Rouge tribunal (ECCC) has convicted only 3 people.', text_de: 'ðŸ“ ORT: Phnom Penh, Kambodscha.\nâ˜ ï¸ ZEITRAUM: 1975–1979 — Rote Khmer unter Pol Pot.\nðŸ’€ TODESOPFER: 1,5–2 Millionen (25% der Bevölkerung Kambodschas).\n\nðŸ“Š Tuol Sleng war eine Schule, umgewandelt in Sicherheitsgefängnis S-21. Von 17.000–20.000 Gefangenen überlebten nur 12. Die Roten Khmer leerten Städte, schafften Geld, Schulen und Religion ab. Brillenträger wurden als Intellektuelle hingerichtet. Massengräber in Choeung Ek enthalten 8.985 Leichen. Ein buddhistischer Stupa zeigt 5.000 Schädel. Das Khmer-Rouge-Tribunal hat nur 3 Personen verurteilt.', layers: ['conflicts'], image: { wiki: 'Tuol_Sleng_Genocide_Museum', caption: 'Tuol Sleng Genocide Museum, Phnom Penh' } },
                { center: [45.9803, 35.1787], zoom: 11, title: 'HALABJA — THE GAS ATTACK', title_de: 'HALABJA — DER GIFTGASANGRIFF', text: 'ðŸ“ LOCATION: Halabja, Kurdistan Region, Iraq.\nâ˜ ï¸ DATE: March 16, 1988 — single day.\nðŸ’€ DEATH TOLL: 5,000 killed instantly; 10,000+ injured; thousands more died from long-term effects.\n\nðŸ“Š On March 16, 1988, Iraqi Air Force jets dropped chemical weapons — mustard gas, sarin, tabun, and VX nerve agent — on the Kurdish city of Halabja. The attack was part of Saddam Hussein\'s Anfal campaign, which killed 50,000–182,000 Kurds and destroyed 4,500 villages. Halabja was the largest chemical weapons attack against a civilian population in history. Survivors suffer from cancer, blindness, and birth defects to this day. The attack was directed by Ali Hassan al-Majid ("Chemical Ali"), who was executed in 2010. The Halabja Monument stands at the site of the attack. Iraq\'s High Tribunal ruled the Anfal campaign a genocide in 2010.', text_de: 'ðŸ“ ORT: Halabja, Kurdistan-Region, Irak.\nâ˜ ï¸ DATUM: 16. März 1988 — ein einziger Tag.\nðŸ’€ TODESOPFER: 5.000 sofort getötet; 10.000+ verletzt.\n\nðŸ“Š Am 16. März 1988 warfen irakische Kampfjets Chemiewaffen — Senfgas, Sarin, Tabun und VX-Nervengift — auf die kurdische Stadt Halabja. Der Angriff war Teil von Saddam Husseins Anfal-Kampagne, die 50.000–182.000 Kurden tötete und 4.500 Dörfer zerstörte. Halabja war der gröÃŸte Chemiewaffenangriff auf eine Zivilbevölkerung in der Geschichte. Ãœberlebende leiden bis heute an Krebs und Erblindung. Das irakische Tribunal erklärte die Anfal-Kampagne 2010 zum Genozid.', layers: ['conflicts'], image: { wiki: 'Halabja_chemical_attack', caption: 'Halabja memorial monument, Iraq' } },
                { center: [40.1409, 35.3362], zoom: 10, title: 'DEIR EZ-ZOR — THE ARMENIAN GENOCIDE', title_de: 'DEIR EZ-ZOR — DER ARMENISCHE GENOZID', text: 'ðŸ“ LOCATION: Deir ez-Zor, Syria — endpoint of death marches.\nâ˜ ï¸ PERIOD: 1915–1923.\nðŸ’€ DEATH TOLL: 1.5 million Armenians killed.\n\nðŸ“Š The Ottoman Empire systematically exterminated its Armenian population during WWI. Men were executed immediately. Women, children, and elderly were force-marched 600+ km through the Syrian desert to Deir ez-Zor — a deliberate death march. Those who survived the march were massacred in the desert. Bodies filled the Euphrates River for months. The Armenian Genocide Memorial in Deir ez-Zor (destroyed by ISIS in 2014) commemorated the victims. Turkey still officially denies the genocide. 34 countries have formally recognized it. Raphael Lemkin, who coined the word "genocide" in 1944, cited the Armenian case as his primary motivation. The genocide dispersed Armenians worldwide — creating a 7-million-strong diaspora.', text_de: 'ðŸ“ ORT: Deir ez-Zor, Syrien — Endpunkt der Todesmärsche.\nâ˜ ï¸ ZEITRAUM: 1915–1923.\nðŸ’€ TODESOPFER: 1,5 Millionen Armenier ermordet.\n\nðŸ“Š Das Osmanische Reich vernichtete systematisch seine armenische Bevölkerung. Frauen, Kinder und Alte wurden 600+ km durch die syrische Wüste getrieben — ein bewusster Todesmarsch. Die Türkei leugnet den Genozid bis heute offiziell. 34 Länder haben ihn anerkannt. Raphael Lemkin, der das Wort \"Genozid\" 1944 prägte, nannte den armenischen Fall als seine Hauptmotivation. Die Diaspora umfasst heute 7 Millionen Armenier weltweit.', layers: ['conflicts'], image: { wiki: 'Armenian_genocide', caption: 'Armenian genocide memorial, Yerevan' } },
                { center: [92.1500, 21.4300], zoom: 8, title: 'ROHINGYA — GENOCIDE IN REAL TIME', title_de: 'ROHINGYA — GENOZID IN ECHTZEIT', text: 'ðŸ“ LOCATION: Rakhine State, Myanmar → Cox\'s Bazar, Bangladesh.\nâ˜ ï¸ PERIOD: 2016–present.\nðŸ’€ DEATH TOLL: 24,000+ killed; 18,000+ women raped; 116,000+ beaten (UN estimates).\n\nðŸ“Š The Rohingya, a Muslim minority of 1.1 million, have been called "the most persecuted people on earth." In August 2017, the Myanmar military launched "clearance operations" — burning 354 villages, systematically raping women, and killing thousands. 740,000 Rohingya fled to Bangladesh in 3 months. The Kutupalong camp complex (960,000+ people) is the largest refugee settlement on Earth. The ICJ ordered Myanmar to prevent genocide (2020). Myanmar\'s military junta seized power in 2021, making accountability nearly impossible. Satellite imagery confirmed the destruction of entire communities. The Rohingya remain stateless — denied citizenship by Myanmar, unable to return.', text_de: 'ðŸ“ ORT: Rakhine-Staat, Myanmar → Cox\'s Bazar, Bangladesch.\nâ˜ ï¸ ZEITRAUM: 2016–heute.\nðŸ’€ TODESOPFER: 24.000+ getötet; 18.000+ Frauen vergewaltigt (UN-Schätzung).\n\nðŸ“Š Die Rohingya, eine muslimische Minderheit von 1,1 Millionen, gelten als \"das am meisten verfolgte Volk der Erde.\" Im August 2017 startete Myanmars Militär \"Säuberungsaktionen\" — 354 Dörfer verbrannt, systematische Vergewaltigungen. 740.000 flohen in 3 Monaten nach Bangladesch. Das Lager Kutupalong (960.000+ Menschen) ist die gröÃŸte Flüchtlingssiedlung der Welt. Der IGH ordnete Myanmar 2020 an, den Genozid zu verhindern. Die Rohingya bleiben staatenlos.', layers: ['conflicts', 'regimes'], image: { wiki: 'Rohingya_genocide', caption: 'Rohingya refugee camp, Cox\'s Bazar' } },
                { center: [20, 20], zoom: 2, title: 'ðŸ•¯ï¸ NEVER AGAIN — THE GLOBAL RECKONING', title_de: 'ðŸ•¯ï¸ NIE WIEDER — DIE GLOBALE BILANZ', text: 'ðŸŒ THE DARKEST CHAPTERS OF HUMANITY — mapped.\n\nðŸ“Š KEY FACTS:\nâ• Total genocide victims in this tour: 5+ million lives\nâ• The Holocaust: 6 million Jews + 5 million others = 11 million total\nâ• Rwanda: fastest genocide — 800,000 in 100 days\nâ• Cambodia: highest percentage — 25% of the population\nâ• Armenia: the genocide that coined the word "genocide"\nâ• UN Genocide Convention adopted: December 9, 1948\nâ• Countries that have ratified it: 153\nâ• ICC established: 2002 — first permanent international criminal court\nâ• Genocides since "Never Again": Cambodia, Rwanda, Bosnia, Darfur, Rohingya\n\nðŸ’¡ "Never Again" was the promise made after the Holocaust. It has been broken repeatedly. These memorial sites exist not as history — but as warnings. The question is not whether it can happen again. It is whether we will recognize it in time.', text_de: 'ðŸŒ DIE DUNKELSTEN KAPITEL DER MENSCHHEIT — kartiert.\n\nðŸ“Š FAKTEN:\nâ• Genozid-Opfer dieser Tour: 5+ Millionen Leben\nâ• Der Holocaust: 6 Millionen Juden + 5 Millionen andere = 11 Millionen\nâ• Ruanda: schnellster Genozid — 800.000 in 100 Tagen\nâ• Kambodscha: höchster Anteil — 25% der Bevölkerung\nâ• Armenien: der Genozid, der das Wort „Genozid" prägte\nâ• UN-Genozidkonvention: 9. Dezember 1948\nâ• Ratifiziert von: 153 Ländern\nâ• ICC gegründet: 2002\nâ• Genozide seit „Nie wieder": Kambodscha, Ruanda, Bosnien, Darfur, Rohingya\n\nðŸ’¡ „Nie wieder" war das Versprechen nach dem Holocaust. Es wurde wiederholt gebrochen. Diese Gedenkorte existieren nicht als Geschichte — sondern als Warnung.', layers: ['conflicts', 'regimes'] }
            ]
        },
        structures: {
            name: 'Greatest Structures of Humanity',
            name_de: 'GröÃŸte Bauwerke der Menschheit',
            category: 'history',
            steps: [
                { center: [31.1342, 29.9792], zoom: 16, pitch: 60, title: 'ðŸ›ï¸ GREAT PYRAMID OF GIZA — THE LAST WONDER', title_de: 'ðŸ›ï¸ GROSSE PYRAMIDE VON GIZEH — DAS LETZTE WELTWUNDER', text: 'ðŸ“ LOCATION: Giza Plateau, Egypt\nðŸ—ï¸ BUILT: ~2560 BC (4,500+ years ago)\nðŸ“ HEIGHT: 146.6m original (138.5m today) — tallest man-made structure for 3,800 years\n\nðŸ“Š KEY FACTS:\nâ• 2.3 million limestone blocks, each weighing 2.5 tonnes on average\nâ• Total weight: 6.1 million tonnes\nâ• Base area: 53,000 m² (13 acres) — accurate to within 15mm\nâ• Construction time: ~20 years\nâ• Workforce: 20,000–30,000 skilled workers (not slaves — paid laborers with medical care)\nâ• Interior temperature: constant 20°C year-round\n\nThe Great Pyramid is the only surviving Wonder of the Ancient World. Built as a tomb for Pharaoh Khufu, it remained the tallest structure on Earth until Lincoln Cathedral was completed in 1311 AD. The precision of the base alignment (within 0.05° of true north) still baffles engineers. In 2017, the ScanPyramids project discovered a 30-meter void inside using cosmic-ray muon imaging — its purpose remains unknown.', text_de: 'ðŸ“ ORT: Gizeh-Plateau, Ã„gypten\nðŸ—ï¸ ERBAUT: ~2560 v. Chr. (über 4.500 Jahre alt)\nðŸ“ HÃ–HE: 146,6m original — 3.800 Jahre lang höchstes Bauwerk der Welt\n\nðŸ“Š FAKTEN:\nâ• 2,3 Millionen Kalksteinblöcke, je ca. 2,5 Tonnen\nâ• Gesamtgewicht: 6,1 Millionen Tonnen\nâ• Bauzeit: ~20 Jahre mit 20.000–30.000 Facharbeitern\nâ• Innentemperatur: konstant 20°C ganzjährig\n\nDie GroÃŸe Pyramide ist das einzige erhaltene Weltwunder der Antike. 2017 entdeckte das ScanPyramids-Projekt mittels kosmischer Myonen einen 30m groÃŸen Hohlraum — sein Zweck ist bis heute unbekannt.', layers: [], image: { wiki: 'Great_Pyramid_of_Giza', caption: 'Great Pyramid of Giza, Egypt' } },
                { center: [116.565, 40.432], zoom: 15, pitch: 60, title: 'ðŸ§± GREAT WALL OF CHINA — THE LONGEST STRUCTURE EVER BUILT', title_de: 'ðŸ§± CHINESISCHE MAUER — DAS LÃ„NGSTE BAUWERK DER GESCHICHTE', text: 'ðŸ“ LOCATION: Badaling Section, Beijing, China\nðŸ—ï¸ BUILT: 7th century BC – 1644 AD (~2,300 years of construction)\nðŸ“ LENGTH: 21,196 km (official survey, 2012) — enough to cross the USA 5 times\n\nðŸ“Š KEY FACTS:\nâ• Not one wall but a network of walls, trenches, and natural barriers\nâ• The Ming Dynasty sections (1368–1644) are the most iconic and best preserved\nâ• Estimated workforce: hundreds of thousands to over 1 million at peak periods\nâ• Construction deaths: estimated 400,000+ — many buried within the wall itself\nâ• Width: 4.5–8m (wide enough for 5 horses or 10 soldiers side by side)\nâ• Watchtowers: 25,000+ along the full length\n\nContrary to popular myth, the Great Wall is NOT visible from space with the naked eye — this was debunked by multiple astronauts including Yang Liwei. The Badaling section near Beijing receives 10+ million visitors per year, making it one of the most visited monuments on Earth.', text_de: 'ðŸ“ ORT: Badaling-Abschnitt, Peking, China\nðŸ—ï¸ ERBAUT: 7. Jhd. v. Chr. – 1644 n. Chr. (~2.300 Jahre Bauzeit)\nðŸ“ LÃ„NGE: 21.196 km — genug, um die USA 5-mal zu durchqueren\n\nðŸ“Š FAKTEN:\nâ• Kein einzelnes Bauwerk, sondern ein Netzwerk aus Mauern, Gräben und Barrieren\nâ• Geschätzte Bautote: 400.000+ — viele in der Mauer selbst begraben\nâ• 25.000+ Wachtürme über die gesamte Länge\n\nEntgegen dem Mythos ist die Mauer NICHT aus dem Weltraum sichtbar — dies wurde von Astronauten wie Yang Liwei widerlegt.', layers: [], image: { wiki: 'Great_Wall_of_China', caption: 'Great Wall at Badaling, China' } },
                { center: [55.2744, 25.1972], zoom: 17, pitch: 60, title: 'ðŸ™ï¸ BURJ KHALIFA — THE TALLEST BUILDING ON EARTH', title_de: 'ðŸ™ï¸ BURJ KHALIFA — DAS HÃ–CHSTE GEBÃ„UDE DER ERDE', text: 'ðŸ“ LOCATION: Downtown Dubai, UAE\nðŸ—ï¸ BUILT: 2004–2010\nðŸ“ HEIGHT: 828m (2,717 ft) — 163 floors\nðŸ’° COST: $1.5 billion USD\n\nðŸ“Š KEY FACTS:\nâ• 828m tall — 320m taller than its nearest rival at time of completion\nâ• 57 elevators, fastest at 10 m/s (36 km/h)\nâ• 12,000 workers on site daily during peak construction\nâ• 330,000 m³ of concrete, 39,000 tonnes of steel rebar\nâ• Foundation: 192 piles driven 50m into the ground\nâ• Exterior cladding: 26,000 glass panels, hand-cut\nâ• Wind sway at top: up to 1.5m\nâ• Temperature difference top vs. base: up to 10°C\nâ• The "Buttressed Core" structural system was invented specifically for this building\n\nDeveloped by Emaar Properties and designed by Adrian Smith of SOM (Chicago). Named after Sheikh Khalifa bin Zayed Al Nahyan. The observation deck on floor 148 (At the Top SKY) at 555m is the highest occupied floor accessible to the public. The tower has its own condensation collection system that harvests 15 million gallons of water per year from the humid Dubai air.', text_de: 'ðŸ“ ORT: Downtown Dubai, VAE\nðŸ—ï¸ ERBAUT: 2004–2010\nðŸ“ HÃ–HE: 828m — 163 Stockwerke\nðŸ’° KOSTEN: $1,5 Milliarden\n\nðŸ“Š FAKTEN:\nâ• 12.000 Arbeiter täglich auf der Baustelle\nâ• 330.000 m³ Beton, 39.000 Tonnen Stahl\nâ• 26.000 Glasscheiben, von Hand geschnitten\nâ• Windauslenkung an der Spitze: bis zu 1,5m\nâ• Eigenes Kondensationssystem: 57 Millionen Liter Wasser/Jahr aus der Luft geerntet', layers: [], image: { wiki: 'Burj_Khalifa', caption: 'Burj Khalifa, Dubai' } },
                { center: [-79.918, 9.08], zoom: 14, pitch: 45, title: 'ðŸš¢ PANAMA CANAL — THE SHORTCUT BETWEEN OCEANS', title_de: 'ðŸš¢ PANAMAKANAL — DIE ABKÃœRZUNG ZWISCHEN DEN OZEANEN', text: 'ðŸ“ LOCATION: Panama (Atlantic to Pacific)\nðŸ—ï¸ BUILT: 1904–1914 (10 years)\nðŸ“ LENGTH: 82 km\nðŸ’° COST: $500 million (1914) — equivalent to ~$15 billion today\n\nðŸ“Š KEY FACTS:\nâ• Saves ships a 12,000 km detour around South America\nâ• 27,000+ workers died during construction (French + American eras) — mostly from malaria and yellow fever\nâ• 3 sets of locks raise ships 26m above sea level through Gatun Lake\nâ• Transit time: 8–10 hours\nâ• Traffic: 14,000+ vessels per year (~40 ships/day), carrying 5% of world trade\nâ• Expanded in 2016: new "Neopanamax" locks accommodate ships up to 366m long\nâ• Revenue: ~$4.3 billion per year (2023)\nâ• A single transit costs $200,000–$800,000 depending on vessel size\n\nThe French attempt (1881–1894) under Ferdinand de Lesseps failed catastrophically — 22,000 workers died and the project went bankrupt. The U.S. succeeded by first eliminating mosquito-borne diseases. The Canal was returned to Panama in 1999 after 85 years of U.S. control.', text_de: 'ðŸ“ ORT: Panama (Atlantik bis Pazifik)\nðŸ—ï¸ ERBAUT: 1904–1914\nðŸ“ LÃ„NGE: 82 km\nðŸ’° KOSTEN: $500 Mio. (1914) — heute ~$15 Mrd.\n\nðŸ“Š FAKTEN:\nâ• Spart Schiffen 12.000 km Umweg um Südamerika\nâ• 27.000+ Tote beim Bau — vor allem durch Malaria und Gelbfieber\nâ• 14.000+ Schiffe/Jahr, 5% des Welthandels\nâ• Eine Durchfahrt kostet $200.000–$800.000\nâ• 2016 erweitert: neue Neopanamax-Schleusen für Schiffe bis 366m', layers: [], image: { wiki: 'Panama_Canal', caption: 'Panama Canal locks' } },
                { center: [-122.4786, 37.8199], zoom: 15, pitch: 60, title: 'ðŸŒ‰ GOLDEN GATE BRIDGE — THE ICON', title_de: 'ðŸŒ‰ GOLDEN GATE BRIDGE — DIE IKONE', text: 'ðŸ“ LOCATION: San Francisco, California, USA\nðŸ—ï¸ BUILT: 1933–1937 (4 years)\nðŸ“ SPAN: 2,737m total; 1,280m main span\nðŸ’° COST: $35 million (1937) — equivalent to ~$780 million today\n\nðŸ“Š KEY FACTS:\nâ• Main towers: 227m tall — taller than a 65-story building\nâ• Cable wire: 129,000 km total — enough to circle Earth 3 times\nâ• Each main cable: 92cm diameter, containing 27,572 individual wires\nâ• Paint color: "International Orange" (#C0362C) — chosen for visibility in fog\nâ• 11 workers died during construction; a safety net saved 19 others ("The Halfway-to-Hell Club")\nâ• Daily traffic: ~100,000 vehicles\nâ• Wind design: withstands winds up to 160 km/h; bridge deck can move 8m laterally\n\nWhen completed, it was the longest suspension bridge in the world — a record it held until 1964. Chief engineer Joseph Strauss insisted on the revolutionary safety net, saving 19 lives. The bridge is continuously painted — a team of 38 painters works year-round touching up the 690,000 m² of surface.', text_de: 'ðŸ“ ORT: San Francisco, Kalifornien, USA\nðŸ—ï¸ ERBAUT: 1933–1937\nðŸ“ SPANNWEITE: 2.737m gesamt; 1.280m Hauptfeld\nðŸ’° KOSTEN: $35 Mio. (1937) — heute ~$780 Mio.\n\nðŸ“Š FAKTEN:\nâ• Hauptpfeiler: 227m hoch\nâ• Kabel: 129.000 km Draht — reicht 3Ã— um die Erde\nâ• Farbe: "International Orange" — gewählt für Sichtbarkeit im Nebel\nâ• 11 Tote beim Bau; ein Sicherheitsnetz rettete 19 weitere Leben\nâ• Täglicher Verkehr: ~100.000 Fahrzeuge', layers: [], image: { wiki: 'Golden_Gate_Bridge', caption: 'Golden Gate Bridge, San Francisco' } },
                { center: [12.4924, 41.8902], zoom: 17, pitch: 60, title: 'ðŸŸï¸ THE COLOSSEUM — ARENA OF BLOOD AND GLORY', title_de: 'ðŸŸï¸ DAS KOLOSSEUM — ARENA AUS BLUT UND RUHM', text: 'ðŸ“ LOCATION: Rome, Italy\nðŸ—ï¸ BUILT: 72–80 AD (8 years)\nðŸ“ SIZE: 189m Ã— 156m; 48m tall — capacity 50,000–80,000 spectators\n\nðŸ“Š KEY FACTS:\nâ• Largest amphitheater ever built — still the largest standing today\nâ• Built by 60,000+ Jewish slaves captured during the Siege of Jerusalem (70 AD)\nâ• 80 entrances allowed the entire venue to fill or empty in 15 minutes\nâ• Featured naval battles (naumachia) — the arena could be flooded to 1.5m depth\nâ• An estimated 400,000 people and 1 million animals died in the arena over 390 years\nâ• The velarium: a retractable canvas sunshade operated by 1,000 sailors\nâ• Beneath the floor: a 2-level underground complex (hypogeum) with 80 elevators for animals\nâ• Games lasted up to 100 days — Emperor Titus inaugurated it with 100 days of games in 80 AD\n\nThe Colosseum is the most iconic symbol of Imperial Rome. Damaged by earthquakes (1349) and stone robbery, only the northern wall stands at full height. It received 7.6 million visitors in 2023 — the most visited monument in Italy.', text_de: 'ðŸ“ ORT: Rom, Italien\nðŸ—ï¸ ERBAUT: 72–80 n. Chr. (8 Jahre)\nðŸ“ GRÃ–SSE: 189m Ã— 156m, 48m Höhe — 50.000–80.000 Zuschauer\n\nðŸ“Š FAKTEN:\nâ• GröÃŸtes jemals gebautes Amphitheater\nâ• Erbaut von 60.000+ jüdischen Sklaven nach der Belagerung Jerusalems\nâ• 80 Eingänge — Füllung/Entleerung in 15 Minuten\nâ• ~400.000 Menschen und 1 Million Tiere starben in der Arena über 390 Jahre\nâ• Velarium: einziehbares Sonnensegel, bedient von 1.000 Matrosen\nâ• 7,6 Millionen Besucher 2023 — meistbesuchtes Monument Italiens', layers: [], image: { wiki: 'Colosseum', caption: 'The Colosseum, Rome' } },
                { center: [8.651, 46.834], zoom: 14, pitch: 45, title: 'ðŸš„ GOTTHARD BASE TUNNEL — DEEPEST AND LONGEST', title_de: 'ðŸš„ GOTTHARD-BASISTUNNEL — TIEFSTER UND LÃ„NGSTER', text: 'ðŸ“ LOCATION: Swiss Alps (Erstfeld to Bodio)\nðŸ—ï¸ BUILT: 1999–2016 (17 years)\nðŸ“ LENGTH: 57.1 km — longest railway tunnel in the world\nðŸ’° COST: CHF 12.2 billion (~$13.5 billion)\n\nðŸ“Š KEY FACTS:\nâ• Maximum rock overburden: 2,300m — the deepest traffic tunnel on Earth\nâ• Rock temperature at deepest point: 46°C\nâ• 28.2 million tonnes of rock excavated — equivalent to 5 Great Pyramids\nâ• 4 massive tunnel boring machines (TBMs), each 400m long\nâ• 9 workers died during construction\nâ• Transit time: 17 minutes (vs. 2+ hours over the old mountain pass)\nâ• Train speed: up to 250 km/h through the tunnel\nâ• Carries 260 freight trains and 65 passenger trains daily\nâ• Reduces the Zurich–Milan journey from 3h40 to 2h40\n\nThe tunnel passes beneath the Gotthard massif at a maximum depth of 2,300m — deeper than any mine most people will ever visit. It replaced a 130-year-old mountain railway and is a key part of the EU\'s Rhine-Alpine freight corridor connecting Rotterdam to Genoa.', text_de: 'ðŸ“ ORT: Schweizer Alpen (Erstfeld–Bodio)\nðŸ—ï¸ ERBAUT: 1999–2016 (17 Jahre)\nðŸ“ LÃ„NGE: 57,1 km — längster Eisenbahntunnel der Welt\nðŸ’° KOSTEN: CHF 12,2 Mrd. (~$13,5 Mrd.)\n\nðŸ“Š FAKTEN:\nâ• Max. Felsüberdeckung: 2.300m — tiefster Verkehrstunnel der Erde\nâ• 28,2 Mio. Tonnen Fels ausgebrochen — entspricht 5 GroÃŸen Pyramiden\nâ• 9 Tote beim Bau\nâ• Fahrtzeit: 17 Minuten (vs. 2+ Stunden über den Pass)\nâ• Zürich–Mailand: von 3h40 auf 2h40 verkürzt', layers: [], image: { wiki: 'Gotthard_Base_Tunnel', caption: 'Gotthard Base Tunnel, Switzerland' } },
                { center: [39.8262, 21.4225], zoom: 16, pitch: 50, title: 'ðŸ•‹ MASJID AL-HARAM — THE HOLIEST SITE ON EARTH', title_de: 'ðŸ•‹ MASJID AL-HARAM — DER HEILIGSTE ORT DER ERDE', text: 'ðŸ“ LOCATION: Mecca, Saudi Arabia\nðŸ—ï¸ EXPANDED: Continuously since 638 AD; latest expansion 2015 (~$100 billion)\nðŸ“ AREA: 356,000 m² — largest mosque and religious structure on Earth\n\nðŸ“Š KEY FACTS:\nâ• Capacity: 4 million worshippers simultaneously during Hajj\nâ• The Kaaba at its center is the most sacred site in Islam — 1.8 billion Muslims face it during prayer 5 times daily\nâ• Annual Hajj pilgrimage: 2–3 million people — the largest annual human gathering on Earth\nâ• The Black Stone (al-Hajar al-Aswad) set in the Kaaba\'s corner is believed to date back to Abraham\nâ• The Grand Mosque has been expanded 10+ times since the 7th century\nâ• The 2015 expansion added 78 escalators, 6 helicopter pads, and 24 minarets (each 89m tall)\nâ• Air conditioning: one of the largest cooling systems in the world — 17,000 tonnes of ice water daily\nâ• The Zamzam well beneath the mosque has been flowing for 4,000+ years\n\nThe annual Hajj is the world\'s largest coordinated human movement. Saudi Arabia has invested over $100 billion in expansions since 2011 to increase capacity from 2 to 4 million pilgrims.', text_de: 'ðŸ“ ORT: Mekka, Saudi-Arabien\nðŸ—ï¸ ERWEITERT: Kontinuierlich seit 638 n. Chr.; letzte Erweiterung 2015 (~$100 Mrd.)\nðŸ“ FLÃ„CHE: 356.000 m² — gröÃŸte Moschee und religiöses Bauwerk der Welt\n\nðŸ“Š FAKTEN:\nâ• Kapazität: 4 Millionen Gläubige gleichzeitig während des Hadsch\nâ• Die Kaaba ist der heiligste Ort des Islam — 1,8 Milliarden Muslime beten 5Ã— täglich in ihre Richtung\nâ• Jährliche Hadsch-Pilgerfahrt: 2–3 Millionen Menschen\nâ• Klimaanlage: 17.000 Tonnen Eiswasser täglich\nâ• Der Zamzam-Brunnen flieÃŸt seit über 4.000 Jahren', layers: [], image: { wiki: 'Masjid_al-Haram', caption: 'Masjid al-Haram, Mecca' } },
                { center: [111.003, 30.823], zoom: 14, pitch: 50, title: 'ðŸ—ï¸ THREE GORGES DAM — THE MOST POWERFUL STRUCTURE', title_de: 'ðŸ—ï¸ DREI-SCHLUCHTEN-DAMM — DAS MÃ„CHTIGSTE BAUWERK', text: 'ðŸ“ LOCATION: Yichang, Hubei Province, China\nðŸ—ï¸ BUILT: 1994–2006 (12 years)\nðŸ“ SIZE: 2,335m long Ã— 185m high\nðŸ’° COST: $31 billion USD\n\nðŸ“Š KEY FACTS:\nâ• 22,500 MW capacity — largest power station on Earth by installed capacity\nâ• Generates ~100 TWh per year — enough to power 60 million households\nâ• Reservoir length: 660 km — visible from space\nâ• 1.3 million people relocated to make way for the reservoir\nâ• 13 cities, 140 towns, and 1,350 villages submerged\nâ• Concrete used: 27.2 million m³ — 20Ã— more than Hoover Dam\nâ• The dam is so massive it measurably slowed Earth\'s rotation by 0.06 microseconds\nâ• 32 turbines, each generating 700 MW — a single turbine powers a city of 500,000\nâ• Ship lift: the world\'s largest — raises 3,000-tonne vessels 113m in 40 minutes\n\nThe Three Gorges Dam is the single most controversial megaproject in modern history. It has prevented an estimated $50+ billion in flood damage but caused severe environmental damage: species displacement, increased landslide risk, and the loss of irreplaceable cultural heritage sites beneath the reservoir.', text_de: 'ðŸ“ ORT: Yichang, Hubei-Provinz, China\nðŸ—ï¸ ERBAUT: 1994–2006 (12 Jahre)\nðŸ“ GRÃ–SSE: 2.335m Länge Ã— 185m Höhe\nðŸ’° KOSTEN: $31 Milliarden\n\nðŸ“Š FAKTEN:\nâ• 22.500 MW — gröÃŸtes Kraftwerk der Erde\nâ• Erzeugt ~100 TWh/Jahr — genug für 60 Millionen Haushalte\nâ• 1,3 Millionen Menschen umgesiedelt, 13 Städte überflutet\nâ• 27,2 Mio. m³ Beton — 20Ã— mehr als der Hoover-Damm\nâ• Der Damm ist so massiv, dass er die Erdrotation um 0,06 Mikrosekunden verlangsamt hat', layers: [], image: { wiki: 'Three_Gorges_Dam', caption: 'Three Gorges Dam, China' } },
                { center: [20, 30], zoom: 2, title: 'ðŸ—ï¸ GREATEST STRUCTURES — THE LEGACY OF BUILDERS', title_de: 'ðŸ—ï¸ GRÃ–SSTE BAUWERKE — DAS VERMÃ„CHTNIS DER BAUMEISTER', text: 'ðŸŒ FROM THE PYRAMIDS TO THE SKYSCRAPERS — mapped.\n\nðŸ“Š RECORDS:\nâ• Oldest: Great Pyramid of Giza (4,500+ years)\nâ• Tallest: Burj Khalifa (828m)\nâ• Longest: Great Wall of China (21,196 km)\nâ• Deepest: Gotthard Base Tunnel (2,300m below surface)\nâ• Most powerful: Three Gorges Dam (22,500 MW)\nâ• Most expensive: Masjid al-Haram expansion ($100+ billion)\nâ• Most deadly to build: Panama Canal (27,000+ deaths)\nâ• Largest religious structure: Masjid al-Haram (356,000 m²)\nâ• Most visited: Colosseum (7.6 million visitors/year)\n\nðŸ’¡ These structures span 4,500 years of human ambition — from the slaves who built the pyramids to the engineers who bored through 57 km of Alpine rock. Each one pushed the limits of what was thought possible. They are monuments not just to power and faith, but to the stubborn human belief that we can reshape the Earth itself.', text_de: 'ðŸŒ VON DEN PYRAMIDEN BIS ZU DEN WOLKENKRATZERN — kartiert.\n\nðŸ“Š REKORDE:\nâ• Ã„ltestes: GroÃŸe Pyramide von Gizeh (4.500+ Jahre)\nâ• Höchstes: Burj Khalifa (828m)\nâ• Längstes: Chinesische Mauer (21.196 km)\nâ• Tiefstes: Gotthard-Basistunnel (2.300m unter der Oberfläche)\nâ• Leistungsstärkstes: Drei-Schluchten-Damm (22.500 MW)\nâ• Teuerstes: Masjid al-Haram Erweiterung ($100+ Mrd.)\nâ• Tödlichster Bau: Panamakanal (27.000+ Tote)\n\nðŸ’¡ Diese Bauwerke umspannen 4.500 Jahre menschlichen Ehrgeiz. Jedes einzelne hat die Grenzen des Möglichen verschoben. Sie sind Monumente nicht nur der Macht und des Glaubens, sondern des hartnäckigen Glaubens, dass wir die Erde selbst umgestalten können.', layers: [] }
            ]
        },
        musicworld: {
        ...
        filmlocations: {
            ...
            category: 'sports',
            steps: [
                { center: [7.934, 33.544], zoom: 14, title: 'ðŸŽ¬ MATMATA, TUNISIA — STAR WARS', title_de: 'ðŸŽ¬ MATMATA, TUNESIEN — STAR WARS', text: 'ðŸ“ Hotel Sidi Driss, Matmata, Tunisia.\n\nðŸ“Š George Lucas chose the underground Berber cave dwellings of Matmata as Luke Skywalker\'s childhood home on Tatooine. The planet\'s name comes from the Tunisian city of Tataouine. Star Wars (1977) was filmed across 7 locations in Tunisia. The sets remain in the desert as tourist attractions. Star Wars is the 2nd highest-grossing franchise ($10.3 billion). You can sleep in Luke\'s dining room for $30/night.', text_de: 'ðŸ“ Hotel Sidi Driss, Matmata, Tunesien.\n\nðŸ“Š George Lucas wählte die unterirdischen Berber-Höhlenwohnungen als Luke Skywalkers Heimat auf Tatooine. Star Wars wurde an 7 Orten in Tunesien gedreht. Die Kulissen stehen noch in der Wüste. Man kann im Original-Hotel für $30/Nacht übernachten.', layers: [], image: { wiki: 'Star_Wars_(film)', caption: 'Matmata cave dwellings, Tunisia' } },
                { center: [18.0944, 42.6407], zoom: 14, title: 'ðŸŽ¬ DUBROVNIK — GAME OF THRONES', title_de: 'ðŸŽ¬ DUBROVNIK — GAME OF THRONES', text: 'ðŸ“ Old Town, Dubrovnik, Croatia — King\'s Landing.\n\nðŸ“Š Dubrovnik\'s medieval walls became King\'s Landing across 8 seasons (2011–2019). Fort Lovrijenac = Red Keep, Jesuit Staircase = Cersei\'s Walk of Shame. GoT tourism increased visitors by 50%. The city charges â‚¬35 entry to limit overcrowding. HBO spent $15 million per episode. 59 Emmy Awards — most for any drama. Franchise revenue: $4+ billion.', text_de: 'ðŸ“ Altstadt, Dubrovnik, Kroatien — Königsmund.\n\nðŸ“Š Dubrovniks mittelalterliche Mauern wurden zu Königsmund. GoT-Tourismus steigerte Besucher um 50%. Die Stadt erhebt â‚¬35 Eintritt gegen Overtourism. 59 Emmy Awards — Rekord. Franchise-Umsatz: $4+ Milliarden.', layers: [], image: { wiki: 'Game_of_Thrones', caption: 'Fort Lovrijenac, Dubrovnik' } },
                { center: [168.66, -44.73], zoom: 10, title: 'ðŸŽ¬ QUEENSTOWN — LORD OF THE RINGS', title_de: 'ðŸŽ¬ QUEENSTOWN — HERR DER RINGE', text: 'ðŸ“ Queenstown & Matamata (Hobbiton), New Zealand.\n\nðŸ“Š Peter Jackson used 150+ locations across New Zealand for LOTR (2001–2003) and The Hobbit (2012–2014). Hobbiton draws 700,000 visitors/year. NZ tourism grew 50% after LOTR (+$1.2 billion/year). The country rebranded as "Middle-earth." The trilogy won 17 Oscars — Return of the King swept all 11 nominations. Franchise revenue: $6+ billion.', text_de: 'ðŸ“ Queenstown & Matamata (Hobbiton), Neuseeland.\n\nðŸ“Š 150+ Drehorte in ganz Neuseeland. Hobbiton zieht 700.000 Besucher/Jahr an. NZ-Tourismus stieg 50% (+$1,2 Mrd./Jahr). 17 Oscars. Franchise-Umsatz: $6+ Milliarden.', layers: [], image: { wiki: 'The_Lord_of_the_Rings_(film_series)', caption: 'Hobbiton, New Zealand' } },
                { center: [-10.5085, 51.7700], zoom: 14, title: 'ðŸŽ¬ SKELLIG MICHAEL — JEDI TEMPLE', title_de: 'ðŸŽ¬ SKELLIG MICHAEL — JEDI-TEMPEL', text: 'ðŸ“ Skellig Michael, County Kerry, Ireland.\n\nðŸ“Š This 6th-century monastic island became Luke Skywalker\'s Jedi Temple in The Force Awakens (2015) and The Last Jedi (2017). The 618 ancient stone steps are real — no CGI. UNESCO World Heritage since 1996. Only 180 visitors/day. After Star Wars, demand tripled — Ireland earned â‚¬35 million in Star Wars tourism. Also a major puffin colony (4,000 breeding pairs).', text_de: 'ðŸ“ Skellig Michael, County Kerry, Irland.\n\nðŸ“Š Diese Klosterinsel wurde Luke Skywalkers Jedi-Tempel in Star Wars VII–VIII. 618 antike Steinstufen, kein CGI. UNESCO-Welterbe. Nur 180 Besucher/Tag. Irland verdiente â‚¬35 Mio. durch Star-Wars-Tourismus.', layers: [], image: { wiki: 'Skellig_Michael', caption: 'Skellig Michael, Ireland' } },
                { center: [29.572, 29.631], zoom: 12, title: 'ðŸŽ¬ WADI RUM — MARS ON EARTH', title_de: 'ðŸŽ¬ WADI RUM — MARS AUF ERDEN', text: 'ðŸ“ Wadi Rum Protected Area, Jordan.\n\nðŸ“Š Wadi Rum has been Mars, alien planets, and ancient Arabia in 20+ films: Lawrence of Arabia (1962), The Martian (2015), Dune (2021), Star Wars IX, Rogue One, Aladdin. UNESCO World Heritage since 2011. Tourism grew 300% since 2015. Bedouin camps now offer "Mars experience" overnight stays. Jordan earns $15+ million/year from film location fees.', text_de: 'ðŸ“ Wadi Rum Schutzgebiet, Jordanien.\n\nðŸ“Š Wadi Rum war Mars, fremde Planeten und antikes Arabien in 20+ Filmen: Lawrence of Arabia, The Martian, Dune, Star Wars. UNESCO-Welterbe. Tourismus stieg 300%. Jordanien verdient $15+ Mio./Jahr an Drehgebühren.', layers: [], image: { wiki: 'Wadi_Rum', caption: 'Wadi Rum desert, Jordan' } },
                { center: [-110.102, 36.983], zoom: 12, title: 'ðŸŽ¬ MONUMENT VALLEY — THE AMERICAN WEST', title_de: 'ðŸŽ¬ MONUMENT VALLEY — DER AMERIKANISCHE WESTEN', text: 'ðŸ“ Monument Valley Navajo Tribal Park, Utah/Arizona.\n\nðŸ“Š John Ford shot 10 films here starting with Stagecoach (1939) — creating the Western genre. The iconic buttes (up to 300m tall) appeared in Easy Rider, Forrest Gump, Thelma & Louise, 2001: A Space Odyssey. Navajo Nation land — the tribe manages all tourism. 500,000+ visitors/year.', text_de: 'ðŸ“ Monument Valley Navajo Tribal Park, Utah/Arizona.\n\nðŸ“Š John Ford drehte 10 Filme hier. Die ikonischen Felsen erschienen in Forrest Gump, Easy Rider, Thelma & Louise. Verwaltet von der Navajo Nation. 500.000+ Besucher/Jahr.', layers: [], image: { wiki: 'Monument_Valley', caption: 'Monument Valley, Utah' } },
                { center: [139.7005, 35.6596], zoom: 14, title: 'ðŸŽ¬ TOKYO — NEON CINEMA CITY', title_de: 'ðŸŽ¬ TOKYO — NEON-KINOSTADT', text: 'ðŸ“ Shibuya Crossing, Tokyo, Japan.\n\nðŸ“Š Shibuya is the world\'s busiest crossing — 3,000 people at once. Featured in: Lost in Translation, Fast & Furious: Tokyo Drift, Avengers: Endgame, John Wick 4. Tokyo is the #3 filming city globally. Akira (1988) and Ghost in the Shell (1995) defined cyberpunk aesthetics that influenced The Matrix and Blade Runner 2049. Japan\'s anime industry: $25 billion/year.', text_de: 'ðŸ“ Shibuya Crossing, Tokyo, Japan.\n\nðŸ“Š Meistbegangenste Kreuzung der Welt. Erschienen in: Lost in Translation, Fast & Furious, Avengers, John Wick. Akira und Ghost in the Shell prägten die Cyberpunk-Ã„sthetik. Anime-Industrie: $25 Mrd./Jahr.', layers: [], image: { wiki: 'Shibuya', caption: 'Shibuya Crossing, Tokyo' } },
                { center: [10, 30], zoom: 2, title: 'ðŸŽ¬ THE REEL WORLD — MAPPED', title_de: 'ðŸŽ¬ DIE FILMISCHE WELT — KARTIERT', text: 'ðŸŒ FROM TATOOINE TO KING\'S LANDING — mapped.\n\nðŸ“Š KEY FACTS:\nâ• Film tourism industry: $48 billion/year\nâ• Visitor boost after filming: 25–300%\nâ• NZ from LOTR: +$1.2 billion/year\nâ• Most filmed city: London (500+ films)\nâ• Star Wars locations: 12 countries\nâ• GoT Dubrovnik: +50% visitors\n\nðŸ’¡ A 2-hour film can transform a village into a global destination overnight. Film tourism is a $48 billion industry — countries compete for productions with billion-dollar tax incentives.', text_de: 'ðŸŒ VON TATOOINE BIS KÃ–NIGSMUND — kartiert.\n\nðŸ“Š FAKTEN:\nâ• Filmtourismus: $48 Milliarden/Jahr\nâ• Besucherzuwachs: 25–300%\nâ• Meistgefilmte Stadt: London (500+ Filme)\n\nðŸ’¡ Ein 2-Stunden-Film kann ein Dorf zum globalen Reiseziel machen.', layers: [] }
            ]
        },
        extremeplaces: {
            ...
            category: 'science',
            steps: [
                { center: [142.773, 63.464], zoom: 10, title: 'ðŸ¥¶ OYMYAKON, SIBERIA — COLDEST INHABITED PLACE', title_de: 'ðŸ¥¶ OJMJAKON, SIBIRIEN — KÃ„LTESTER BEWOHNTER ORT', text: 'ðŸ“ Oymyakon, Sakha Republic, Russia.\nðŸŒ¡ï¸ RECORD: âˆ’67.7°C (February 6, 1933)\nðŸ‘¥ POPULATION: ~500\n\nðŸ“Š Oymyakon and nearby Verkhoyansk compete for the title of coldest permanently inhabited place on Earth. At âˆ’50°C (normal winter), car engines run 24/7 — turn them off and they won\'t restart. Glasses freeze to faces. Pen ink freezes. Fish freeze solid within 30 seconds of being caught. Locals eat frozen raw horse liver and drink "kumis" (fermented mare\'s milk). The cemetery requires 3 days of bonfire to thaw the ground before burial. Despite this, people have lived here for centuries — Yakut herders adapted to survive in conditions that would kill most humans in hours.', text_de: 'ðŸ“ Ojmjakon, Republik Sacha, Russland.\nðŸŒ¡ï¸ REKORD: âˆ’67,7°C (6. Februar 1933)\nðŸ‘¥ EINWOHNER: ~500\n\nðŸ“Š Kältester permanent bewohnter Ort der Erde. Bei âˆ’50°C laufen Automotoren 24/7. Brillen frieren am Gesicht fest. Tinte gefriert. Fische sind 30 Sekunden nach dem Fang tiefgefroren. Für Beerdigungen muss der Boden 3 Tage mit Lagerfeuern aufgetaut werden.', layers: [], image: { wiki: 'Oymyakon', caption: 'Oymyakon in winter, Siberia' } },
                { center: [40.300, 14.240], zoom: 12, title: 'ðŸ”¥ DALLOL, ETHIOPIA — HOTTEST PLACE ON EARTH', title_de: 'ðŸ”¥ DALLOL, Ã„THIOPIEN — HEISSESTER ORT DER ERDE', text: 'ðŸ“ Dallol, Danakil Depression, Ethiopia.\nðŸŒ¡ï¸ RECORD: 41.1°C annual average — highest ever recorded for any inhabited location\nðŸ‘¥ POPULATION: ~30 (Afar salt miners)\n\nðŸ“Š Dallol sits in the Danakil Depression — 125m below sea level, with active volcanoes, toxic gas vents, and acid pools. Salt miners work in 50°C+ heat, cutting salt blocks by hand and loading them onto camels. A single camel carries 60 kg over 75 km to market. Workers earn $1–2 per day. The landscape looks like another planet — neon yellow sulfur springs, emerald acid lakes, and orange iron oxide formations. Scientists study Dallol as a Mars analog. The nearest road is 75 km away. No electricity, no running water, no phone signal.', text_de: 'ðŸ“ Dallol, Danakil-Senke, Ã„thiopien.\nðŸŒ¡ï¸ REKORD: 41,1°C Jahresdurchschnitt — höchster je gemessener Wert\nðŸ‘¥ EINWOHNER: ~30 (Afar-Salzarbeiter)\n\nðŸ“Š Dallol liegt in der Danakil-Senke — 125m unter dem Meeresspiegel, mit aktiven Vulkanen und Säurepools. Salzarbeiter arbeiten bei 50°C+, schneiden Salzblöcke von Hand. Die Landschaft sieht aus wie ein fremder Planet — NASA nutzt Dallol als Mars-Analogon.', layers: [], image: { wiki: 'Dallol_(volcano)', caption: 'Dallol sulfur springs, Ethiopia' } },
                { center: [-69.546, -14.633], zoom: 14, title: 'â›ï¸ LA RINCONADA, PERU — HIGHEST CITY ON EARTH', title_de: 'â›ï¸ LA RINCONADA, PERU — HÃ–CHSTE STADT DER ERDE', text: 'ðŸ“ La Rinconada, Puno Region, Peru.\nðŸ”ï¸ ALTITUDE: 5,100m above sea level\nðŸ‘¥ POPULATION: ~50,000\n\nðŸ“Š The world\'s highest permanent settlement sits on a glacier at the base of a gold mine. There is no running water, no sewage system, and no waste collection — the streets are lined with mercury-contaminated mud from gold processing. Workers use the "cachorreo" system — they work 30 days for free, then on the 31st day they can keep whatever ore they find. Oxygen levels are 50% of sea level. Altitude sickness, pneumonia, and mercury poisoning are endemic. Women are banned from entering the mines — believed to bring bad luck. Despite conditions, people flood in because gold = hope.', text_de: 'ðŸ“ La Rinconada, Region Puno, Peru.\nðŸ”ï¸ HÃ–HE: 5.100m über dem Meeresspiegel\nðŸ‘¥ EINWOHNER: ~50.000\n\nðŸ“Š Höchste permanente Siedlung der Welt — auf einem Gletscher an einer Goldmine. Kein flieÃŸendes Wasser, keine Kanalisation. Arbeiter arbeiten 30 Tage kostenlos — am 31. Tag dürfen sie behalten, was sie finden. Sauerstoffgehalt: 50% des Meeresspiegels.', layers: [], image: { wiki: 'La_Rinconada,_Peru', caption: 'La Rinconada, Peru, 5100m' } },
                { center: [-12.280, -37.112], zoom: 10, title: 'ðŸï¸ TRISTAN DA CUNHA — MOST REMOTE INHABITED ISLAND', title_de: 'ðŸï¸ TRISTAN DA CUNHA — ENTLEGENSTE BEWOHNTE INSEL', text: 'ðŸ“ Edinburgh of the Seven Seas, Tristan da Cunha.\nðŸ“ DISTANCE: 2,434 km from nearest land (Saint Helena)\nðŸ‘¥ POPULATION: 245 (2024) — 80 families with only 8 surnames\n\nðŸ“Š Tristan da Cunha is the most remote permanently inhabited island on Earth. A mail ship visits 8–9 times per year. There is no airport — arrival requires a 7-day ship journey from Cape Town. The island has no traffic lights, no fast food, and one pub (the Albatross Bar). Everyone works — either in the lobster factory (primary export: $4 million/year) or farming. In 1961, the entire population was evacuated to England after a volcanic eruption — most returned after 2 years, finding England "too crowded." Internet arrived in 2006. The island declared the world\'s largest marine protection zone (687,000 km²) in 2020.', text_de: 'ðŸ“ Edinburgh of the Seven Seas, Tristan da Cunha.\nðŸ“ ENTFERNUNG: 2.434 km zum nächsten Land\nðŸ‘¥ EINWOHNER: 245 — 80 Familien, nur 8 Nachnamen\n\nðŸ“Š Entlegenste bewohnte Insel der Erde. Post kommt 8–9Ã— pro Jahr per Schiff. Kein Flughafen — Anreise: 7 Tage per Schiff ab Kapstadt. 1961 wurde die gesamte Bevölkerung nach England evakuiert — die meisten kehrten zurück, weil England \"zu voll\" war.', layers: [], image: { wiki: 'Tristan_da_Cunha', caption: 'Edinburgh of the Seven Seas' } },
                { center: [134.755, -29.014], zoom: 12, title: 'ðŸ•³ï¸ COOBER PEDY, AUSTRALIA — UNDERGROUND CITY', title_de: 'ðŸ•³ï¸ COOBER PEDY, AUSTRALIEN — UNTERIRDISCHE STADT', text: 'ðŸ“ Coober Pedy, South Australia.\nðŸŒ¡ï¸ SURFACE TEMPERATURE: Up to 52°C in summer\nðŸ‘¥ POPULATION: ~1,700\n\nðŸ“Š Coober Pedy is the "opal capital of the world" — producing 70% of the world\'s gem-quality opals. But it\'s also famous because most residents live underground. The surface is so hot that people carved homes ("dugouts") into the sandstone — maintaining a natural 23–25°C year-round without air conditioning. There are underground churches, hotels, a bookshop, a bar, and a swimming pool. The name "Coober Pedy" comes from the Aboriginal "kupa-piti" — meaning "white man\'s hole." Mad Max: Beyond Thunderdome (1985) was filmed here. The landscape is so Mars-like that it was used in Pitch Black (2000).', text_de: 'ðŸ“ Coober Pedy, Südaustralien.\nðŸŒ¡ï¸ OBERFLÃ„CHENTEMPERATUR: Bis zu 52°C im Sommer\nðŸ‘¥ EINWOHNER: ~1.700\n\nðŸ“Š "Opal-Hauptstadt der Welt" — 70% der weltweiten Edelopale. Die meisten Bewohner leben unterirdisch. In den Sandstein gehauene Wohnungen halten natürliche 23–25°C ohne Klimaanlage. Es gibt unterirdische Kirchen, Hotels und ein Schwimmbad.', layers: [], image: { wiki: 'Coober_Pedy', caption: 'Underground home in Coober Pedy' } },
                { center: [-148.683, 60.774], zoom: 14, title: 'ðŸ¢ WHITTIER, ALASKA — ONE BUILDING TOWN', title_de: 'ðŸ¢ WHITTIER, ALASKA — EIN-GEBÃ„UDE-STADT', text: 'ðŸ“ Begich Towers, Whittier, Alaska, USA.\nðŸ‘¥ POPULATION: ~220 — nearly all live in ONE building\n\nðŸ“Š Almost the entire population of Whittier lives in a single 14-story building: Begich Towers, a former Cold War military barracks. The building contains apartments, a post office, a police station, a general store, a laundromat, a medical clinic, and a church. The only road access is through a 4 km one-lane tunnel through a mountain — shared with trains on a schedule. In winter, winds reach 100+ km/h and snowfall exceeds 6 meters. Children walk to school through an underground tunnel. The building was built by the US Army in 1957.', text_de: 'ðŸ“ Begich Towers, Whittier, Alaska, USA.\nðŸ‘¥ EINWOHNER: ~220 — fast alle leben in EINEM Gebäude\n\nðŸ“Š Fast die gesamte Bevölkerung lebt in einem einzigen 14-stöckigen Gebäude: Begich Towers, eine ehemalige Militärkaserne. Darin: Wohnungen, Post, Polizei, Laden, Arztpraxis und Kirche. Einziger StraÃŸenzugang: ein 4-km-Einspurtunnel durch einen Berg.', layers: [], image: { wiki: 'Whittier,_Alaska', caption: 'Begich Towers, Whittier' } },
                { center: [88.195, 69.347], zoom: 10, title: 'â˜ ï¸ NORILSK, RUSSIA — MOST POLLUTED CITY', title_de: 'â˜ ï¸ NORILSK, RUSSLAND — GIFTIGSTE STADT', text: 'ðŸ“ Norilsk, Krasnoyarsk Krai, Russia.\nðŸŒ¡ï¸ WINTER: âˆ’50°C; 2 months of polar night (no sun at all)\nðŸ‘¥ POPULATION: ~175,000\n\nðŸ“Š Norilsk is the northernmost city with 100,000+ people — and one of the most polluted places on Earth. The Norilsk Nickel smelter (world\'s largest) has released so much sulfur dioxide that no trees grow within 30 km. The snow turns black. The rivers run red from nickel contamination. Life expectancy is 10 years below Russia\'s average. The city was built by Gulag prisoners (1935–1953) — an estimated 17,000 died during construction. Norilsk is a "closed city" — foreigners need special permission to visit. Despite all this, workers stay because salaries are 3Ã— the Russian average.', text_de: 'ðŸ“ Norilsk, Region Krasnojarsk, Russland.\nðŸŒ¡ï¸ WINTER: âˆ’50°C; 2 Monate Polarnacht\nðŸ‘¥ EINWOHNER: ~175.000\n\nðŸ“Š Nördlichste GroÃŸstadt der Welt — und einer der giftigsten Orte der Erde. Norilsk Nickel hat so viel Schwefeldioxid freigesetzt, dass im Umkreis von 30 km keine Bäume wachsen. Der Schnee ist schwarz. Die Flüsse rot. Lebenserwartung 10 Jahre unter Russlands Durchschnitt. Erbaut von Gulag-Gefangenen — 17.000 starben beim Bau.', layers: [], image: { wiki: 'Norilsk', caption: 'Norilsk industrial landscape' } },
                { center: [20, 30], zoom: 2, title: 'ðŸŒ EXTREME LIVING — THE HUMAN SPIRIT', title_de: 'ðŸŒ EXTREMES LEBEN — DER MENSCHLICHE GEIST', text: 'ðŸŒ FROM âˆ’67°C TO +52°C — mapped.\n\nðŸ“Š KEY FACTS:\nâ• Coldest inhabited: Oymyakon (âˆ’67.7°C)\nâ• Hottest inhabited: Dallol (41.1°C average)\nâ• Highest city: La Rinconada (5,100m)\nâ• Most remote island: Tristan da Cunha (2,434 km)\nâ• Most polluted city: Norilsk (no trees in 30 km)\nâ• Smallest "town": Whittier (220 people, 1 building)\nâ• Deepest inhabited: Coober Pedy (underground)\n\nðŸ’¡ These places prove that humans will live anywhere — from frozen tundra to toxic wastelands to underground caves. The question isn\'t where we can survive. It\'s what we\'re willing to endure for gold, warmth, isolation, or simply the stubbornness of calling a place home.', text_de: 'ðŸŒ VON âˆ’67°C BIS +52°C — kartiert.\n\nðŸ“Š FAKTEN:\nâ• Kältester Ort: Ojmjakon (âˆ’67,7°C)\nâ• HeiÃŸester Ort: Dallol (41,1°C Schnitt)\nâ• Höchste Stadt: La Rinconada (5.100m)\nâ• Entlegenste Insel: Tristan da Cunha (2.434 km)\n\nðŸ’¡ Menschen leben überall — von der Tundra bis in giftige Industrieruinen. Die Frage ist nicht, wo wir überleben können, sondern was wir dafür in Kauf nehmen.', layers: [] }
            ]
        },
        revolutions: {
            ...
            category: 'history',
            steps: [
                { center: [2.3694, 48.8566], zoom: 14, title: 'PARIS 1789 — THE FRENCH REVOLUTION', title_de: 'PARIS 1789 — DIE FRANZÃ–SISCHE REVOLUTION', text: 'ðŸ“ Place de la Bastille, Paris.\n\nðŸ“Š On July 14, 1789, a mob stormed the Bastille fortress. The revolution abolished the monarchy, declared the Rights of Man, and executed Louis XVI by guillotine. The Reign of Terror killed ~40,000. Napoleon seized power in 1799, spreading revolutionary ideals across Europe by force. July 14 remains France\'s national day.', text_de: 'ðŸ“ Place de la Bastille, Paris.\n\nðŸ“Š Am 14. Juli 1789 stürmte ein Mob die Bastille. Die Revolution schaffte die Monarchie ab und guillotinierte Ludwig XVI. Die Schreckensherrschaft tötete ~40.000. Napoleon verbreitete die Ideale in ganz Europa.', layers: [], image: { wiki: 'French_Revolution', caption: 'Storming of the Bastille, 1789' } },
                { center: [30.3351, 59.9343], zoom: 14, title: 'ST. PETERSBURG 1917 — THE RUSSIAN REVOLUTION', title_de: 'ST. PETERSBURG 1917 — DIE RUSSISCHE REVOLUTION', text: 'ðŸ“ Winter Palace, Saint Petersburg.\n\nðŸ“Š On October 25, 1917, Bolsheviks stormed the Winter Palace and created the world\'s first communist state. Tsar Nicholas II was executed with his family in 1918. The Civil War (1917–22) killed 7–12 million. The USSR became a nuclear superpower controlling half of Europe until 1991.', text_de: 'ðŸ“ Winterpalast, Sankt Petersburg.\n\nðŸ“Š Am 25. Oktober 1917 stürmten Bolschewiki den Winterpalast. Zar Nikolaus II. wurde 1918 hingerichtet. Der Bürgerkrieg tötete 7–12 Millionen. Die UdSSR kontrollierte die Hälfte Europas bis 1991.', layers: [], image: { wiki: 'Russian_Revolution', caption: 'Storming the Winter Palace, 1917' } },
                { center: [-82.3666, 23.1136], zoom: 12, title: 'HAVANA 1959 — THE CUBAN REVOLUTION', title_de: 'HAVANNA 1959 — DIE KUBANISCHE REVOLUTION', text: 'ðŸ“ Havana, Cuba.\n\nðŸ“Š On January 1, 1959, Castro\'s guerrillas overthrew Batista. The revolution triggered the Bay of Pigs (1961), the Cuban Missile Crisis (1962) — humanity\'s closest brush with nuclear war — and a US embargo lasting 60+ years. Castro ruled until 2008.', text_de: 'ðŸ“ Havanna, Kuba.\n\nðŸ“Š Am 1. Januar 1959 stürzte Castro Batista. Die Revolution löste die Kubakrise 1962 aus — der nächste Punkt eines Atomkriegs. US-Embargo seit 60+ Jahren.', layers: [], image: { wiki: 'Cuban_Revolution', caption: 'Castro entering Havana, 1959' } },
                { center: [51.3890, 35.6892], zoom: 12, title: 'TEHRAN 1979 — THE ISLAMIC REVOLUTION', title_de: 'TEHERAN 1979 — DIE ISLAMISCHE REVOLUTION', text: 'ðŸ“ Azadi Tower, Tehran, Iran.\n\nðŸ“Š Ayatollah Khomeini overthrew the US-backed Shah, creating the world\'s first Islamic republic. The US embassy hostage crisis (444 days) shattered relations permanently. The Iran-Iraq War (1980–88) killed 1 million. Iran\'s Revolutionary Guard now controls vast military and economic power.', text_de: 'ðŸ“ Azadi-Turm, Teheran, Iran.\n\nðŸ“Š Khomeini stürzte den US-gestützten Schah und schuf die erste Islamische Republik. Die US-Geiselkrise (444 Tage) zerstörte die Beziehungen. Der Iran-Irak-Krieg tötete 1 Million.', layers: [], image: { wiki: 'Iranian_Revolution', caption: 'Protests in Tehran, 1979' } },
                { center: [13.3777, 52.5163], zoom: 14, title: 'BERLIN 1989 — THE FALL OF THE WALL', title_de: 'BERLIN 1989 — DER MAUERFALL', text: 'ðŸ“ Brandenburg Gate, Berlin.\n\nðŸ“Š On November 9, 1989, the Wall opened after 28 years. 140+ people died trying to cross. The fall triggered communist collapse across Eastern Europe. Germany reunified October 3, 1990. The USSR dissolved December 26, 1991. The most consequential peaceful revolution in modern history.', text_de: 'ðŸ“ Brandenburger Tor, Berlin.\n\nðŸ“Š Am 9. November 1989 fiel die Mauer nach 28 Jahren. 140+ Menschen starben bei Fluchtversuchen. Der Mauerfall löste den Zusammenbruch des Kommunismus in Osteuropa aus. Die folgenreichste friedliche Revolution der Neuzeit.', layers: [], image: { wiki: 'Fall_of_the_Berlin_Wall', caption: 'Berliners on the Wall, 1989' } },
                { center: [10.1658, 36.8065], zoom: 12, title: 'TUNIS 2010 — THE ARAB SPRING', title_de: 'TUNIS 2010 — DER ARABISCHE FRÃœHLING', text: 'ðŸ“ Avenue Habib Bourguiba, Tunis.\n\nðŸ“Š Mohamed Bouazizi set himself on fire on December 17, 2010. His act — spread on social media — toppled Ben Ali in 28 days. The "Arab Spring" spread to Egypt, Libya, Syria, Yemen. Only Tunisia achieved lasting democracy. Syria descended into civil war (500,000+ dead).', text_de: 'ðŸ“ Avenue Habib Bourguiba, Tunis.\n\nðŸ“Š Mohamed Bouazizi zündete sich am 17. Dezember 2010 an. Sein Akt stürzte Ben Ali in 28 Tagen. Der Arabische Frühling erreichte Ã„gypten, Libyen, Syrien. Nur Tunesien erreichte Demokratie. Syrien: 500.000+ Tote.', layers: [], image: { wiki: 'Arab_Spring', caption: 'Protests in Tunis, 2011' } },
                { center: [30.5234, 50.4501], zoom: 14, title: 'KYIV 2014 — EUROMAIDAN', title_de: 'KIEW 2014 — EUROMAIDAN', text: 'ðŸ“ Maidan Nezalezhnosti, Kyiv, Ukraine.\n\nðŸ“Š President Yanukovych rejected the EU under Russian pressure. Hundreds of thousands occupied Maidan for 3 months. Snipers killed 108 protesters. Yanukovych fled. Russia annexed Crimea and launched the 2022 full-scale invasion — the largest war in Europe since 1945.', text_de: 'ðŸ“ Maidan Nesaleschnosti, Kiew, Ukraine.\n\nðŸ“Š Janukowytsch lehnte die EU unter russischem Druck ab. Scharfschützen töteten 108 Demonstranten. Russland annektierte die Krim und begann 2022 den gröÃŸten Krieg in Europa seit 1945.', layers: [], image: { wiki: 'Euromaidan', caption: 'Euromaidan protests, 2014' } },
                { center: [20, 30], zoom: 2, title: 'âœŠ REVOLUTIONS — THE PATTERN', title_de: 'âœŠ REVOLUTIONEN — DAS MUSTER', text: 'ðŸŒ FROM THE BASTILLE TO THE MAIDAN — mapped.\n\nðŸ“Š DEATH TOLLS:\nâ• French Revolution: ~40,000\nâ• Russian Revolution: 7–12 million\nâ• Cuban → Missile Crisis: near nuclear war\nâ• Berlin Wall: 28 years, 140+ deaths\nâ• Arab Spring: 4 dictators toppled, 1 democracy\nâ• Euromaidan → full-scale war (2022–)\n\nðŸ’¡ Every revolution follows a pattern: injustice → spark → mass mobilization → regime falls → power vacuum. The question is always what comes after. France got Napoleon. Russia got Stalin. Tunisia got democracy. Syria got war. Toppling a regime is the easy part.', text_de: 'ðŸŒ VON DER BASTILLE BIS ZUM MAIDAN — kartiert.\n\nðŸ“Š OPFERZAHLEN:\nâ• Französische Revolution: ~40.000\nâ• Russische Revolution: 7–12 Millionen\nâ• Berliner Mauer: 28 Jahre, 140+ Tote\nâ• Arabischer Frühling: 4 Diktatoren, 1 Demokratie\n\nðŸ’¡ Jede Revolution folgt einem Muster. Ein Regime zu stürzen ist der einfache Teil. Was danach kommt, ist die wahre Revolution.', layers: [] }
            ]
        },
        pandemics: {
            ...
            category: 'science',
            steps: [
                { center: [28.9784, 41.0082], zoom: 12, title: 'ðŸ’€ CONSTANTINOPLE 541 — PLAGUE OF JUSTINIAN', title_de: 'ðŸ’€ KONSTANTINOPEL 541 — JUSTINIANISCHE PEST', text: 'ðŸ“ Constantinople (modern Istanbul), Byzantine Empire.\n\nðŸ“Š In 541 AD, the first recorded bubonic plague pandemic arrived in Constantinople via grain ships from Egypt. At its peak, 5,000–10,000 people died per day. Emperor Justinian himself was infected but survived. Total death toll: 25–50 million (25–50% of the world population). The plague destroyed Justinian\'s dream of reuniting the Roman Empire and contributed to the end of antiquity. The bacterium Yersinia pestis was carried by fleas on rats. The pandemic recurred in waves for 200 years.', text_de: 'ðŸ“ Konstantinopel (heute Istanbul), Byzantinisches Reich.\n\nðŸ“Š 541 n. Chr. erreichte die erste dokumentierte Pest-Pandemie Konstantinopel über Getreideschiffe aus Ã„gypten. Auf dem Höhepunkt starben 5.000–10.000 Menschen pro Tag. Kaiser Justinian infizierte sich, überlebte aber. 25–50 Millionen Tote (25–50% der Weltbevölkerung).', layers: [], image: { wiki: 'Plague_of_Justinian', caption: 'Constantinople, 6th century' } },
                { center: [9.19, 45.46], zoom: 10, title: 'ðŸ’€ MILAN/EUROPE 1347 — THE BLACK DEATH', title_de: 'ðŸ’€ MAILAND/EUROPA 1347 — DER SCHWARZE TOD', text: 'ðŸ“ Northern Italy — epicenter of European spread.\n\nðŸ“Š The Black Death (1347–1353) killed 75–200 million people — roughly 30–60% of Europe\'s population. It arrived via Genoese trading ships from the Crimea. Symptoms: buboes (swollen lymph nodes), fever, necrosis — death within 3–5 days. Entire villages were wiped out. The labor shortage that followed ended feudalism, raised wages, and empowered peasants. Flagellant movements and Jewish pogroms swept Europe. The plague returned in waves for 400 years. It remains the deadliest pandemic in human history by percentage of population killed.', text_de: 'ðŸ“ Norditalien — Epizentrum der europäischen Ausbreitung.\n\nðŸ“Š Der Schwarze Tod (1347–1353) tötete 75–200 Millionen Menschen — 30–60% der europäischen Bevölkerung. Symptome: Beulen, Fieber, Nekrose — Tod innerhalb von 3–5 Tagen. Der Arbeitskräftemangel danach beendete die Leibeigenschaft. Die tödlichste Pandemie der Menschheitsgeschichte.', layers: [], image: { wiki: 'Black_Death', caption: 'The Triumph of Death, Pieter Bruegel' } },
                { center: [-99.1332, 19.4326], zoom: 10, title: 'ðŸ’€ TENOCHTITLÁN 1520 — SMALLPOX IN THE NEW WORLD', title_de: 'ðŸ’€ TENOCHTITLÁN 1520 — POCKEN IN DER NEUEN WELT', text: 'ðŸ“ Tenochtitlán (modern Mexico City).\n\nðŸ“Š When Hernán Cortés arrived in 1519, Tenochtitlán had 200,000+ inhabitants — larger than any European city. Spanish soldiers brought smallpox, which spread catastrophically through populations with zero immunity. Within a century, 90% of the indigenous population of the Americas died — an estimated 56 million people. This was the largest demographic collapse in human history. Smallpox killed the Aztec emperor Cuitláhuac after just 80 days of rule. The population of central Mexico fell from 25 million (1519) to 1 million (1620). Smallpox was eventually eradicated in 1980 — the only human disease ever eliminated.', text_de: 'ðŸ“ Tenochtitlán (heute Mexiko-Stadt).\n\nðŸ“Š Spanische Soldaten brachten Pocken — innerhalb eines Jahrhunderts starben 90% der indigenen Bevölkerung der Amerikas (~56 Millionen). Der gröÃŸte demographische Zusammenbruch der Geschichte. Die Pocken wurden 1980 ausgerottet — die einzige je eliminierte Krankheit.', layers: [], image: { wiki: 'Smallpox', caption: 'Aztec smallpox victims, Florentine Codex' } },
                { center: [-0.1276, 51.5074], zoom: 12, title: 'ðŸ’€ LONDON 1665 — THE GREAT PLAGUE', title_de: 'ðŸ’€ LONDON 1665 — DIE GROSSE PEST', text: 'ðŸ“ City of London, England.\n\nðŸ“Š The Great Plague of London (1665–66) killed 100,000 people — 25% of London\'s population. Bodies were collected in death carts at night ("Bring out your dead!"). Mass graves called "plague pits" were dug across the city. The wealthy fled; the poor were locked in their homes with a red cross on the door. Samuel Pepys documented the horror in his famous diary. The plague ended abruptly — possibly helped by the Great Fire of London (1666), which destroyed the dense, rat-infested medieval city. London was rebuilt in brick and stone, creating the modern city.', text_de: 'ðŸ“ City of London, England.\n\nðŸ“Š Die GroÃŸe Pest von London (1665–66) tötete 100.000 Menschen — 25% der Bevölkerung. Leichen wurden nachts mit Karren eingesammelt. Die Reichen flohen, die Armen wurden in ihren Häusern eingeschlossen. Das GroÃŸe Feuer von 1666 beendete möglicherweise die Pest, indem es die rattenverseuchte Stadt zerstörte.', layers: [], image: { wiki: 'Great_Plague_of_London', caption: 'London plague pit, 1665' } },
                { center: [-97.7431, 38.5], zoom: 5, title: 'ðŸ’€ WORLDWIDE 1918 — SPANISH FLU', title_de: 'ðŸ’€ WELTWEIT 1918 — SPANISCHE GRIPPE', text: 'ðŸ“ Camp Funston, Fort Riley, Kansas, USA — likely origin.\n\nðŸ“Š The 1918 influenza pandemic (H1N1) infected 500 million people — one-third of the world\'s population. Death toll: 50–100 million (3–5% of global population). It killed more people than World War I. Unlike normal flu, it disproportionately killed healthy adults aged 20–40 through cytokine storms. The virus spread globally via WWI troop movements. Cities that imposed early lockdowns (St. Louis) had 50% lower death rates than those that didn\'t (Philadelphia). The pandemic ended by 1920 as survivors gained immunity. It was called "Spanish Flu" only because Spain, being neutral in WWI, freely reported cases.', text_de: 'ðŸ“ Camp Funston, Fort Riley, Kansas, USA — vermutlicher Ursprung.\n\nðŸ“Š Die Spanische Grippe (1918, H1N1) infizierte 500 Millionen Menschen. 50–100 Millionen Tote — mehr als der Erste Weltkrieg. Sie tötete besonders gesunde 20–40-Jährige. Städte mit frühen Lockdowns hatten 50% weniger Tote. "Spanische Grippe" nur, weil Spanien als neutrales Land frei berichtete.', layers: [], image: { wiki: 'Spanish_flu', caption: 'Emergency hospital, Camp Funston, 1918' } },
                { center: [29.3639, -2.0469], zoom: 8, title: 'ðŸ’€ CENTRAL AFRICA — HIV/AIDS', title_de: 'ðŸ’€ ZENTRALAFRIKA — HIV/AIDS', text: 'ðŸ“ Kinshasa, Democratic Republic of Congo — likely origin.\n\nðŸ“Š HIV/AIDS has killed 40+ million people since the 1980s. The virus crossed from chimpanzees to humans around 1920 in Kinshasa. It remained undetected for decades before exploding globally. By 2024: 39 million people living with HIV, 630,000 annual deaths. Sub-Saharan Africa bears 70% of the global burden. The US lost 330,000 to AIDS before effective treatment (ART) arrived in 1996. ART now allows near-normal lifespans but costs $20,000+/year without subsidies. No vaccine exists despite 40 years of research. The pandemic exposed catastrophic stigma, homophobia, and healthcare inequality.', text_de: 'ðŸ“ Kinshasa, DR Kongo — vermutlicher Ursprung.\n\nðŸ“Š HIV/AIDS hat 40+ Millionen Menschen getötet. Das Virus sprang um 1920 in Kinshasa von Schimpansen auf Menschen über. 39 Millionen leben mit HIV. Subsahara-Afrika trägt 70% der globalen Last. Antiretrovirale Therapie ermöglicht heute fast normale Lebenserwartung. Keine Impfung trotz 40 Jahren Forschung.', layers: [], image: { wiki: 'HIV/AIDS', caption: 'AIDS memorial quilt, Washington DC' } },
                { center: [114.2599, 30.5928], zoom: 12, title: 'ðŸ’€ WUHAN 2019 — COVID-19', title_de: 'ðŸ’€ WUHAN 2019 — COVID-19', text: 'ðŸ“ Huanan Seafood Market, Wuhan, Hubei, China.\n\nðŸ“Š In December 2019, a novel coronavirus (SARS-CoV-2) emerged in Wuhan. By March 2020, it was a global pandemic. Official death toll: 7+ million (WHO estimate: 15–20 million excess deaths). The virus triggered the largest global lockdown in history — 4.4 billion people confined. Economic damage: $12+ trillion. Vaccines developed in record time (11 months vs. typical 10+ years). mRNA technology (Pfizer/BioNTech, Moderna) represented a medical revolution. 13+ billion doses administered globally. The pandemic exposed healthcare inequality, accelerated remote work, and permanently changed how the world functions.', text_de: 'ðŸ“ Huanan Seafood Market, Wuhan, Hubei, China.\n\nðŸ“Š Im Dezember 2019 tauchte SARS-CoV-2 in Wuhan auf. 7+ Millionen offizielle Tote (WHO: 15–20 Mio.). GröÃŸter globaler Lockdown: 4,4 Milliarden Menschen eingesperrt. Wirtschaftsschaden: $12+ Billionen. Impfstoffe in Rekordzeit (11 Monate). 13+ Milliarden Dosen verabreicht.', layers: [], image: { wiki: 'COVID-19_pandemic', caption: 'Wuhan lockdown, January 2020' } },
                { center: [20, 30], zoom: 2, title: 'ðŸ’€ PANDEMICS — THE INVISIBLE ENEMY', title_de: 'ðŸ’€ PANDEMIEN — DER UNSICHTBARE FEIND', text: 'ðŸŒ FROM THE PLAGUE TO COVID — mapped.\n\nðŸ“Š DEATH TOLLS:\nâ• Plague of Justinian (541): 25–50 million\nâ• Black Death (1347): 75–200 million\nâ• Smallpox in Americas (1520): 56 million\nâ• Great Plague of London (1665): 100,000\nâ• Spanish Flu (1918): 50–100 million\nâ• HIV/AIDS (1981–): 40+ million\nâ• COVID-19 (2019–): 15–20 million\n\nðŸ’¡ Pandemics have killed more humans than all wars combined. They topple empires, reshape economies, and accelerate scientific breakthroughs. The pattern repeats: emergence → denial → panic → adaptation → recovery. Each pandemic teaches us the same lesson — and each time, we forget.', text_de: 'ðŸŒ VON DER PEST BIS COVID — kartiert.\n\nðŸ“Š OPFERZAHLEN:\nâ• Justinianische Pest: 25–50 Millionen\nâ• Schwarzer Tod: 75–200 Millionen\nâ• Pocken in Amerika: 56 Millionen\nâ• Spanische Grippe: 50–100 Millionen\nâ• HIV/AIDS: 40+ Millionen\nâ• COVID-19: 15–20 Millionen\n\nðŸ’¡ Pandemien haben mehr Menschen getötet als alle Kriege zusammen. Das Muster wiederholt sich: Entstehung → Leugnung → Panik → Anpassung → Erholung.', layers: [] }
            ]
        },
        hondius: {
            ...
            category: 'science',
            steps: [
                { center: [-68.30, -54.81], zoom: 10, title: 'ðŸš¢ USHUAIA — DEPARTURE (April 1, 2026)', title_de: 'ðŸš¢ USHUAIA — ABFAHRT (1. April 2026)', text: 'ðŸ“ Port of Ushuaia, Tierra del Fuego, Argentina — the southernmost city on Earth.\n\nðŸ“Š On April 1, 2026, the Dutch-flagged expedition cruise ship MV Hondius (Oceanwide Expeditions) departed Ushuaia for a 40-day transatlantic voyage to Tenerife. Aboard: 88 passengers and 59 crew — 147 people from 23 countries.\n\nðŸš¢ THE SHIP: Built 2019, 107.6m long, ice class 6, capacity 170 passengers. Specializes in polar expedition cruises to Antarctica, the Arctic, and remote Atlantic islands.\n\nðŸ¦  THE PATHOGEN: Andes virus (Orthohantavirus andesense) — a hantavirus endemic to Patagonian long-tailed pygmy rice mice (Oligoryzomys longicaudatus). Case fatality rate: 30–40%. Incubation period: 7–39 days. It is the only hantavirus with confirmed human-to-human transmission. The virus was likely contracted during a shore excursion in southern Patagonia before or during embarkation.\n\nâš ï¸ At this point, no one aboard knows the virus is present. The incubation clock is ticking.', text_de: 'ðŸ“ Hafen von Ushuaia, Feuerland, Argentinien — die südlichste Stadt der Welt.\n\nðŸ“Š Am 1. April 2026 verlieÃŸ das niederländische Expeditionsschiff MV Hondius (Oceanwide Expeditions) Ushuaia für eine 40-tägige Transatlantikreise nach Teneriffa. An Bord: 88 Passagiere und 59 Crew — 147 Personen aus 23 Ländern.\n\nðŸš¢ DAS SCHIFF: Baujahr 2019, 107,6m lang, Eisklasse 6. Spezialisiert auf Polarexpeditionen.\n\nðŸ¦  DER ERREGER: Andes-Virus (Orthohantavirus andesense) — ein Hantavirus, endemisch bei patagonischen Langschwanz-Zwergbeutelratten. Sterblichkeitsrate: 30–40%. Inkubationszeit: 7–39 Tage. Das einzige Hantavirus mit bestätigter Mensch-zu-Mensch-Ãœbertragung.', layers: [], image: { wiki: 'Ushuaia', caption: 'Port of Ushuaia, Argentina — departure point' } },
                { center: [-62.00, -64.50], zoom: 6, title: 'ðŸ§Š ANTARCTIC PENINSULA — THE EXPEDITION', title_de: 'ðŸ§Š ANTARKTISCHE HALBINSEL — DIE EXPEDITION', text: 'ðŸ“ Antarctic Peninsula — Drake Passage crossing and Antarctic landings.\n\nðŸ“Š After crossing the notorious Drake Passage (800 km of the roughest seas on Earth), the MV Hondius conducted expedition landings along the Antarctic Peninsula. Passengers explored penguin colonies, glaciers, and research stations via Zodiac boats.\n\nðŸŒ¡ï¸ CONDITIONS: Air temperatures -5°C to +2°C. Wind chill down to -20°C. Passengers were in close quarters during Zodiac landings and shared common areas aboard.\n\nðŸ”¬ EPIDEMIOLOGICAL SIGNIFICANCE: The confined shipboard environment — shared dining, narrow corridors, communal lounges — created ideal conditions for person-to-person transmission of the Andes virus via respiratory droplets. The close-contact nature of expedition cruises amplifies transmission risk compared to larger cruise vessels.\n\nðŸ“Š At this stage, the virus may already be spreading silently. Andes hantavirus symptoms mimic altitude sickness or flu — fever, myalgia, headache — making early detection extremely difficult at sea.', text_de: 'ðŸ“ Antarktische Halbinsel — Drake-Passage-Ãœberquerung und Antarktis-Landungen.\n\nðŸ“Š Nach der Ãœberquerung der Drake-Passage führte die MV Hondius Expeditionslandungen entlang der Antarktischen Halbinsel durch. Passagiere erkundeten Pinguinkolonien und Gletscher.\n\nðŸ”¬ EPIDEMIOLOGISCHE BEDEUTUNG: Die beengte Schiffsumgebung — gemeinsames Essen, enge Gänge — schuf ideale Bedingungen für die Mensch-zu-Mensch-Ãœbertragung des Andes-Virus über Tröpfcheninfektion.\n\nðŸ“Š In diesem Stadium breitet sich das Virus möglicherweise bereits unbemerkt aus. Die Symptome ähneln einer Grippe — Fieber, Muskelschmerzen, Kopfschmerzen.', layers: [], image: { wiki: 'Antarctic_Peninsula', caption: 'Antarctic Peninsula expedition landing' } },
                { center: [-36.51, -54.27], zoom: 8, title: 'ðŸ”ï¸ SOUTH GEORGIA — SHACKLETON\'S ISLAND', title_de: 'ðŸ”ï¸ SÃœDGEORGIEN — SHACKLETONS INSEL', text: 'ðŸ“ South Georgia Island — British Overseas Territory, South Atlantic.\n\nðŸ“Š The MV Hondius visited South Georgia, one of the most wildlife-rich islands on Earth. Home to 450,000+ king penguins, millions of fur seals, and the grave of Sir Ernest Shackleton at Grytviken.\n\nðŸŒ GEOGRAPHY: 170 km long, covered by glaciers and mountains up to 2,934m (Mount Paget). The island has no permanent population — only researchers at the British Antarctic Survey station.\n\nðŸ¦  VIRUS TIMELINE: By this point in the voyage (mid-April), the first infected passengers may be entering the prodromal phase — the early stage before severe symptoms appear. The incubation period of 7–39 days means the virus timeline is staggered across multiple individuals.\n\nðŸ“Š South Georgia is 1,390 km from the Falkland Islands and 2,150 km from the nearest hospital. Any medical emergency at sea requires helicopter evacuation or days of sailing — a critical vulnerability for disease outbreaks on expedition ships.', text_de: 'ðŸ“ Südgeorgien — Britisches Ãœberseegebiet, Südatlantik.\n\nðŸ“Š Die MV Hondius besuchte Südgeorgien — Heimat von 450.000+ Königspinguinen und dem Grab von Sir Ernest Shackleton in Grytviken.\n\nðŸ¦  VIRUS-ZEITLINIE: Zu diesem Zeitpunkt könnten die ersten Infizierten die Prodromalphase erreichen — das Frühstadium vor schweren Symptomen. Die Inkubationszeit von 7–39 Tagen verteilt den Krankheitsverlauf über mehrere Personen.\n\nðŸ“Š Südgeorgien liegt 2.150 km vom nächsten Krankenhaus entfernt — ein kritischer Schwachpunkt bei Krankheitsausbrüchen auf Expeditionsschiffen.', layers: [], image: { wiki: 'South_Georgia', caption: 'King penguins at Salisbury Plain, South Georgia' } },
                { center: [-12.28, -37.11], zoom: 8, title: 'ðŸï¸ TRISTAN DA CUNHA — THE MOST REMOTE ISLAND', title_de: 'ðŸï¸ TRISTAN DA CUNHA — DIE ENTLEGENSTE INSEL', text: 'ðŸ“ Tristan da Cunha — the world\'s most remote inhabited island, South Atlantic.\n\nðŸ“Š The MV Hondius called at Tristan da Cunha, population 245 — located 2,434 km from the nearest land (Saint Helena). The island has no airport; visitors arrive by ship only.\n\nðŸ”’ BIOSECURITY CONCERN: Tristan da Cunha has an extremely vulnerable population. With only 245 residents sharing 8 surnames and no hospital (only a single doctor), any infectious disease introduction could be devastating. The island has no ICU capability and emergency evacuation requires days of sailing.\n\nðŸ¦  STATUS: At this stage of the voyage, the ship\'s medical team had not yet identified any unusual illness cluster. Standard expedition health protocols were in place, but Andes hantavirus was not on any screening checklist — it had never before been documented outside South America.\n\nðŸ“Š The island declared the world\'s largest marine protection zone (687,000 km²) in 2020.', text_de: 'ðŸ“ Tristan da Cunha — die entlegenste bewohnte Insel der Welt, Südatlantik.\n\nðŸ“Š Die MV Hondius legte an Tristan da Cunha an (245 Einwohner, 2.434 km vom nächsten Land entfernt).\n\nðŸ”’ BIOSICHERHEIT: Tristan da Cunha hat eine extrem verletzliche Bevölkerung. Mit nur 245 Einwohnern, einem einzigen Arzt und keiner Intensivstation könnte jede Infektionskrankheit verheerend wirken.\n\nðŸ¦  STATUS: Zu diesem Zeitpunkt hatte das medizinische Team an Bord noch kein ungewöhnliches Krankheitscluster identifiziert. Das Andes-Hantavirus war nie zuvor auÃŸerhalb Südamerikas dokumentiert worden.', layers: [], image: { wiki: 'Tristan_da_Cunha', caption: 'Edinburgh of the Seven Seas, Tristan da Cunha' } },
                { center: [-5.72, -15.97], zoom: 9, title: 'ðŸï¸ SAINT HELENA — NAPOLEON\'S EXILE', title_de: 'ðŸï¸ ST. HELENA — NAPOLEONS EXIL', text: 'ðŸ“ Saint Helena — British Overseas Territory, South Atlantic. Famous as Napoleon Bonaparte\'s place of exile (1815–1821).\n\nðŸ“Š The MV Hondius visited Saint Helena, population ~4,500. The island received an airport in 2017 (notoriously difficult to land at due to wind shear), but the ship arrived by sea.\n\nðŸ¥ MEDICAL FACILITIES: Saint Helena has a small general hospital with basic capabilities. Like Tristan da Cunha, the island is highly vulnerable to infectious disease outbreaks due to limited healthcare infrastructure and geographic isolation.\n\nðŸ¦  VIRUS TIMELINE: Late April. The first symptomatic cases may now be presenting with what appears to be flu-like illness. On an expedition cruise with a small medical facility (typically one doctor, one nurse), differentiating between common respiratory illness and a rare hemorrhagic fever virus is nearly impossible without laboratory testing.\n\nðŸ“Š Historical note: Napoleon died on Saint Helena on May 5, 1821. Recent studies suggest arsenic poisoning from the wallpaper in his residence at Longwood House.', text_de: 'ðŸ“ St. Helena — Britisches Ãœberseegebiet, Südatlantik. Berühmt als Napoleons Verbannungsort (1815–1821).\n\nðŸ“Š Die MV Hondius besuchte St. Helena (~4.500 Einwohner).\n\nðŸ¦  VIRUS-ZEITLINIE: Ende April. Die ersten symptomatischen Fälle könnten nun grippeähnliche Symptome zeigen. Auf einem Expeditionsschiff mit begrenzter medizinischer Ausstattung ist die Unterscheidung zwischen gewöhnlichen Atemwegserkrankungen und einem seltenen hämorrhagischen Fiebervirus nahezu unmöglich ohne Labortests.', layers: [], image: { wiki: 'Saint_Helena', caption: 'Jamestown, Saint Helena' } },
                { center: [-14.37, -7.95], zoom: 9, title: 'ðŸï¸ ASCENSION ISLAND — MID-ATLANTIC OUTPOST', title_de: 'ðŸï¸ ASCENSION ISLAND — POSTEN IM MITTELATLANTIK', text: 'ðŸ“ Ascension Island — British Overseas Territory, mid-Atlantic. A volcanic island with RAF and US military presence.\n\nðŸ“Š The MV Hondius called at Ascension Island, population ~800 (mostly military and government staff). The island hosts a critical RAF/USAF air base (Wideawake Airfield) used during the Falklands War (1982).\n\nðŸ¦  OUTBREAK DETECTION: In late April/early May, the ship\'s medical team began to identify a pattern — multiple passengers presenting with severe respiratory distress, fever, and rapidly declining oxygen levels. This was no ordinary flu.\n\nâš ï¸ CRITICAL MOMENT: The ship\'s doctor contacted Oceanwide Expeditions headquarters in the Netherlands, who alerted WHO and ECDC. Blood samples were arranged for testing. On May 2, 2026, WHO was officially notified of a suspected hantavirus cluster aboard the MV Hondius.\n\nðŸ“Š Ascension Island is home to the world\'s largest green turtle nesting colony (up to 20,000 nests/year) and is a critical node in the global submarine cable network.', text_de: 'ðŸ“ Ascension Island — Britisches Ãœberseegebiet, Mittelatlantik. Vulkaninsel mit RAF- und US-Militärpräsenz.\n\nðŸ¦  AUSBRUCH ERKANNT: Ende April/Anfang Mai identifizierte das medizinische Team ein Muster — mehrere Passagiere mit schwerer Atemnot, Fieber und rapide sinkenden Sauerstoffwerten.\n\nâš ï¸ KRITISCHER MOMENT: Am 2. Mai 2026 wurde die WHO offiziell über einen vermuteten Hantavirus-Cluster an Bord informiert. Blutproben wurden für Tests arrangiert.\n\nðŸ“Š Ascension Island beherbergt die weltweit gröÃŸte Brutkolonie der Grünen Meeresschildkröte (bis zu 20.000 Nester/Jahr).', layers: [], image: { wiki: 'Ascension_Island', caption: 'Georgetown, Ascension Island' } },
                { center: [-22.93, 16.00], zoom: 7, title: 'âš“ CAPE VERDE — EMERGENCY ANCHORAGE', title_de: 'âš“ KAP VERDE — NOTANKERUNG', text: 'ðŸ“ Cape Verde (Cabo Verde) — island nation off the west coast of Africa.\n\nðŸ“Š The MV Hondius passed through or anchored near Cape Verde as the outbreak situation escalated. By this point:\n\nâ˜ ï¸ CASUALTIES: The first deaths occurred at sea — a Dutch couple who had been among the earliest symptomatic cases. A German national also died.\n\nðŸ¥ MEDICAL CRISIS: The ship\'s small medical facility was overwhelmed. Hantavirus Cardiopulmonary Syndrome (HCPS) causes rapid fluid accumulation in the lungs — patients essentially drown internally. Without ICU-level care (mechanical ventilation, ECMO), the mortality rate is extremely high.\n\nðŸ“¡ COORDINATION: An international response was now underway. Spain\'s health ministry was coordinating with WHO, ECDC, and multiple national health agencies to prepare for the ship\'s arrival in Tenerife. Military transport aircraft were being mobilized for repatriation.\n\nðŸ“Š FINAL TOLL AT SEA: 9 cases total (7 laboratory-confirmed Andes virus, 2 probable). 3 deaths. Case fatality rate on board: 33% — consistent with known Andes virus lethality.', text_de: 'ðŸ“ Kap Verde (Cabo Verde) — Inselstaat vor der Westküste Afrikas.\n\nðŸ“Š Die MV Hondius passierte Kap Verde, während sich die Ausbruchssituation verschärfte.\n\nâ˜ ï¸ OPFER: Die ersten Todesfälle ereigneten sich auf See — ein niederländisches Ehepaar und ein deutscher Staatsangehöriger.\n\nðŸ¥ MEDIZINISCHE KRISE: Hantavirus-Kardiopulmonales Syndrom (HCPS) verursacht schnelle Flüssigkeitsansammlung in der Lunge — Patienten ertrinken innerlich. Ohne Intensivmedizin (Beatmung, ECMO) ist die Sterblichkeit extrem hoch.\n\nðŸ“Š BILANZ AUF SEE: 9 Fälle (7 laborbestätigt, 2 Verdachtsfälle). 3 Tote. Sterblichkeitsrate: 33%.', layers: [], image: { wiki: 'Cape_Verde', caption: 'Cape Verde Islands, Atlantic Ocean' } },
                { center: [-16.53, 28.05], zoom: 10, title: 'ðŸ¥ TENERIFE — DISEMBARKATION & REPATRIATION (May 10, 2026)', title_de: 'ðŸ¥ TENERIFFA — AUSSCHIFFUNG & RÃœCKFÃœHRUNG (10. Mai 2026)', text: 'ðŸ“ Port of Granadilla, Tenerife, Canary Islands, Spain — final destination.\n\nðŸ“Š On May 10, 2026, the MV Hondius arrived at Tenerife. All 147 persons were disembarked under strict biosecurity protocols. Medical screening, PCR testing, and contact tracing were conducted by Spanish health authorities with WHO/ECDC coordination.\n\nâœˆï¸ REPATRIATION OPERATION: An unprecedented multinational evacuation followed:\nUSA: 17 passengers → military charter to Nebraska Medical Center (UNMC) quarantine facility\nUK: ~20 passengers → RAF flight to Arrowe Park Hospital, Wirral (same facility used for COVID Diamond Princess evacuees 2020)\nNetherlands: 8 → charter to Eindhoven military air base\nFrance: 5 → Paris\nGermany: 4 → repatriated via government arrangement\nBelgium: 2 → Brussels\nArgentina, Portugal, Greece, Australia, New Zealand, Ireland, Spain, South Africa, Canada, Switzerland — various arrangements.\n\nCrew nationalities included: Philippines, India, Ukraine, Guatemala, Montenegro.\n\nðŸ”¬ All 147 persons were classified as high-risk contacts with a mandatory 42-day health monitoring period. The MV Hondius was sent to the Netherlands for full disinfection and deep cleaning.', text_de: 'ðŸ“ Hafen von Granadilla, Teneriffa, Kanarische Inseln, Spanien — Endziel.\n\nðŸ“Š Am 10. Mai 2026 erreichte die MV Hondius Teneriffa. Alle 147 Personen wurden unter strengen Biosicherheitsprotokollen von Bord genommen.\n\nâœˆï¸ RÃœCKFÃœHRUNGSOPERATION:\nUSA: 17 Passagiere → Nebraska Medical Center Quarantäne\nUK: ~20 → Arrowe Park Hospital, Wirral\nNiederlande: 8 → Eindhoven Militärbasis\nFrankreich: 5 → Paris\nDeutschland: 4 → Rückführung\nBelgien: 2 → Brüssel\nWeitere: Argentinien, Portugal, Griechenland, Australien, Neuseeland, Irland, Spanien, Südafrika, Kanada, Schweiz.\n\nCrew-Nationalitäten: Philippinen, Indien, Ukraine, Guatemala, Montenegro.\n\nðŸ”¬ 42-tägige Gesundheitsüberwachung für alle 147 Personen. Das Schiff wurde zur Desinfektion in die Niederlande geschickt.', layers: [], image: { wiki: 'Tenerife', caption: 'Port of Tenerife, Canary Islands' } },
                { center: [-20, 15], zoom: 2, title: 'ðŸŒ MV HONDIUS — GLOBAL RESPONSE MAP', title_de: 'ðŸŒ MV HONDIUS — GLOBALE REAKTIONSKARTE', text: 'ðŸŒ FROM PATAGONIA TO 23 NATIONS — a single ship, one virus, global consequences.\n\nðŸ“Š THE OUTBREAK IN NUMBERS:\nâ• Ship: MV Hondius (Oceanwide Expeditions, Netherlands)\nâ• Route: Ushuaia → Antarctic Peninsula → South Georgia → Tristan da Cunha → Saint Helena → Ascension Island → Cape Verde → Tenerife\nâ• Voyage: April 1 – May 10, 2026 (40 days)\nâ• Aboard: 147 people (88 passengers, 59 crew) from 23 countries\nâ• Pathogen: Andes virus (Orthohantavirus) — only hantavirus with human-to-human transmission\nâ• Cases: 9 total (7 confirmed, 2 probable)\nâ• Deaths: 3 (Dutch couple, German national)\nâ• Case fatality rate: 33%\nâ• Monitoring period: 42 days for all contacts\nâ• Repatriation: 13+ countries via military and charter flights\nâ• Public risk assessment (WHO/ECDC): LOW\n\nðŸ”¬ WHY IT MATTERS: The MV Hondius outbreak demonstrated that even a small expedition ship can become a floating epidemiological crisis. A rare South American pathogen — never before seen outside the continent — infected passengers from 23 nations and triggered the mobilization of military assets across 3 continents. The outbreak also highlighted the vulnerability of remote island communities along the ship\'s route.\n\nðŸ’¡ Data snapshot: May 11, 2026. Situation may evolve during the 42-day monitoring period.', text_de: 'ðŸŒ VON PATAGONIEN IN 23 NATIONEN — ein Schiff, ein Virus, globale Konsequenzen.\n\nðŸ“Š DER AUSBRUCH IN ZAHLEN:\nâ• Schiff: MV Hondius (Oceanwide Expeditions, Niederlande)\nâ• Route: Ushuaia → Antarktis → Südgeorgien → Tristan da Cunha → St. Helena → Ascension → Kap Verde → Teneriffa\nâ• Reise: 1. April – 10. Mai 2026 (40 Tage)\nâ• An Bord: 147 Personen aus 23 Ländern\nâ• Erreger: Andes-Virus — einziges Hantavirus mit Mensch-zu-Mensch-Ãœbertragung\nâ• Fälle: 9 (7 bestätigt, 2 Verdacht)\nâ• Tote: 3\nâ• Sterblichkeit: 33%\nâ• Rückführung: 13+ Länder via Militär- und Charterflüge\nâ• Risikobewertung (WHO/ECDC): GERING\n\nðŸ”¬ WARUM ES WICHTIG IST: Der Ausbruch zeigte, dass selbst ein kleines Expeditionsschiff zur epidemiologischen Krise werden kann. Ein seltener südamerikanischer Erreger — nie zuvor auÃŸerhalb des Kontinents gesehen — infizierte Passagiere aus 23 Nationen und löste den Einsatz militärischer Ressourcen auf 3 Kontinenten aus.\n\nðŸ’¡ Datenstand: 11. Mai 2026. Situation kann sich während der 42-tägigen Ãœberwachung ändern.', layers: [] }
            ]
        }
    };
    ...
    function startTour(tourId) {
        ...
        setStatus(currentLang === 'de' ? 'GEFÃœHRTE TOUR: ' + nm + ' — ÃœBERSICHT' : 'GUIDED TOUR: ' + nm + ' — OVERVIEW');
