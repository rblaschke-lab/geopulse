...
window._applyToursDE = function() {
    ...
    // ═══════════════════════════════════════════
    // LOST WONDERS — VERLORENE WUNDER
    // ═══════════════════════════════════════════
    applyDE('lostwonders', [
        { t: '🏛️ KOLOSSEUM — ROMS ARENA DES TODES', d: '📍 ERBAUT: 70–80 n. Chr. unter den Kaisern Vespasian und Titus.\n📏 KAPAZITÄT: 50.000–80.000 Zuschauer.\n📊 Das Kolosseum ist das größte jemals gebaute Amphitheater. Die Eröffnungsspiele dauerten 100 Tage — 9.000 Tiere wurden getötet. Gladiatorenkämpfe fanden 400 Jahre lang statt. Der Boden konnte für Seeschlachten geflutet werden. Unter der Arena (dem Hypogeum) befand sich ein Netzwerk aus Tunneln, Käfigen und Aufzügen. Das Velarium — ein einziehbares Sonnensegel — schützte die Zuschauer. 7 Millionen Besucher pro Jahr.' },
        { t: '🏛️ PETRA — DIE ROSENROTE STADT', d: '📍 ERBAUT: ~300 v. Chr. von den Nabatäern.\n📏 GRÖSSE: Über 800 einzelne Bauwerke in den Sandstein gehauen.\n📊 Petra war eine blühende Handelsstadt an der Kreuzung der Weihrauch-, Gewürz- und Seidenstraße. Die Schatzkammer (Al-Khazneh) ist 40m hoch. Die Stadt hatte ein ausgeklügeltes Wassersystem, das 30.000 Einwohner in der Wüste versorgte. Nach einem Erdbeben 363 n. Chr. wurde Petra verlassen und erst 1812 vom Schweizer Entdecker Johann Ludwig Burckhardt wiederentdeckt. Nur 15% sind archäologisch erforscht.' },
        { t: '🏛️ MACHU PICCHU — DIE VERLORENE INKA-STADT', d: '📍 ERBAUT: ~1450 n. Chr. unter Inka-Herrscher Pachacútec.\n📏 HÖHE: 2.430m über dem Meeresspiegel.\n📊 Machu Picchu wurde 1911 von Hiram Bingham wiederentdeckt — die Spanier fanden es nie. Die Inka bauten ohne Mörtel, Rad oder Eisenwerkzeuge. Die Steine passen so präzise, dass keine Messerklinge dazwischen passt. Über 600 Terrassen verhinderten Erosion und speisten die Landwirtschaft. Die Stadt hatte fließendes Wasser über 750m Kanäle. 1,5 Millionen Besucher pro Jahr — streng limitiert zum Schutz.' },
        { t: '🏛️ ANGKOR WAT — DER GRÖSSTE TEMPEL DER WELT', d: '📍 ERBAUT: 1113–1150 n. Chr. von König Suryavarman II.\n📏 FLÄCHE: 162,6 Hektar — das größte religiöse Bauwerk der Erde.\n📊 Angkor Wat wurde als hinduistischer Tempel für Vishnu erbaut und später zum buddhistischen Tempel umgewandelt. Der Wassergraben ist 190m breit. Die Reliefs erstrecken sich über 600m — die längste durchgehende Steinschnitzerei der Welt. Auf dem Höhepunkt lebten in der Angkor-Region bis zu 1 Million Menschen — die größte vorindustrielle Stadt. Das Khmer-Reich fiel 1431 an die Thai-Invasion.' },
        { t: '🏛️ OSTERINSEL — DIE MOAI-STATUEN', d: '📍 STANDORT: Osterinsel (Rapa Nui), Chile — 3.700 km vom Festland.\n📊 887 Moai-Statuen, 13m hoch, bis zu 82 Tonnen schwer. Geschnitzt zwischen 1250–1500 n. Chr. aus vulkanischem Tuff des Steinbruchs Rano Raraku. Die Rapa Nui bewegten sie mit Holzschlitten und Seilen — was zur Abholzung und zum ökologischen Kollaps der Insel führte. Als die Europäer 1722 ankamen, hatte die Bevölkerung 90% ihres Höchststands verloren. Die Moai repräsentieren vergöttlichte Vorfahren.' },
        { t: '🔺 GROSSE PYRAMIDE VON GIZEH — ÄGYPTEN', d: '📍 ERBAUT: ~2560 v. Chr. für Pharao Cheops.\n📏 HÖHE: 146,6m — 3.800 Jahre lang das höchste Bauwerk der Welt.\n📊 2,3 Millionen Steinblöcke, je 2,5 Tonnen schwer. Über 20.000 Arbeiter bauten 20 Jahre lang. Die Seiten sind auf 1/15 Grad genau nach Norden ausgerichtet. Die Große Pyramide ist das einzige noch existierende der Sieben Weltwunder der Antike. Im Inneren gibt es drei Kammern, den Großen Gang und geheimnisvolle Lüftungsschächte.' },
        { t: '🏛️ CHICHÉN ITZÁ — MAYA-PYRAMIDE DER SCHLANGE', d: '📍 ERBAUT: ~600–1000 n. Chr. von den Maya.\n📊 Zur Tag-und-Nacht-Gleiche erzeugt die Sonne einen Schatteneffekt auf der Treppe des Kukulcán — eine kriechende Schlange aus Licht und Schatten. Die Pyramide hat 365 Stufen — eine für jeden Tag. In der Cenote Sagrada opferten die Maya Gold, Jade und Menschen. Chichén Itzá wurde 2007 zu einem der Neuen Sieben Weltwunder gewählt.' },
        { t: '🏛️ CHINESISCHE MAUER — DAS LÄNGSTE BAUWERK', d: '📍 ERBAUT: ~700 v. Chr. – 1644 n. Chr. (über 2.000 Jahre).\n📏 LÄNGE: 21.196 km — die längste von Menschen geschaffene Struktur.\n📊 Mehrere Dynastien errichteten die Mauer zum Schutz vor nördlichen Invasionen. Die Ming-Dynastie baute den bekanntesten Abschnitt (1368–1644). Schätzungsweise starben 400.000 Arbeiter beim Bau — viele wurden in der Mauer begraben. Trotz Mythos: Die Mauer ist aus dem Weltraum NICHT mit bloßem Auge sichtbar. 10 Millionen Besucher pro Jahr.' },
        { t: '🕌 TAJ MAHAL — EIN DENKMAL DER LIEBE', d: '📍 ERBAUT: 1632–1653 von Mogulkaiser Shah Jahan für seine Frau Mumtaz Mahal.\n📏 HÖHE: 73m — perfekt symmetrisch in jeder Dimension.\n📊 20.000 Handwerker aus ganz Asien arbeiteten 22 Jahre. Materialien wurden von über 1.000 Elefanten aus Indien, Zentralasien und Sri Lanka transportiert. Der weiße Makrana-Marmor wechselt die Farbe: rosa im Morgengrauen, weiß mittags, golden bei Sonnenuntergang, blau-grau im Mondlicht. Die Kalligraphie wird nach oben größer — damit sie vom Boden gleichmäßig wirkt. 8 Millionen Besucher pro Jahr.' },
        { t: '🏛️ WELTWUNDER — DAS VERMÄCHTNIS', d: '🌍 DIE GRÖSSTEN MONUMENTE DER MENSCHHEIT — kartiert.\n\n📊 FAKTEN:\n• Von den 7 Antiken Weltwundern existiert nur noch die Große Pyramide von Gizeh\n• Die Neuen 7 Weltwunder (2007, 100+ Mio. Stimmen): Chinesische Mauer, Petra, Kolosseum, Chichén Itzá, Machu Picchu, Taj Mahal, Christusstatue\n• Jährliche Besucher zusammen: 80+ Millionen\n• Ältestes: Große Pyramide (~4.500 Jahre)\n• Größtes: Chinesische Mauer (21.196 km)\n• Meistbesucht: Kolosseum (7 Mio./Jahr)\n• Alle 9 Stationen dieser Tour sind UNESCO-Welterbestätten\n\n💡 Diese Monumente erinnern uns daran, dass menschlicher Ehrgeiz, Kunstfertigkeit und Ingenieurswesen immer über das scheinbar Mögliche hinausgingen — in jeder Kultur und jeder Epoche.' }
    ]);
